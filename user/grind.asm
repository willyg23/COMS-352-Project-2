...
go(int which_child)
{
  ...
  mkdir("grindir");
      ...
      96:	2ee50513          	add	a0,a0,750 # 1380 <malloc+0x108>
      9a:	00001097          	auipc	ra,0x1
      9e:	e0e080e7          	jalr	-498(ra) # ea8 <mkdir>
  if(chdir("grindir") != 0){
      a2:	00001517          	auipc	a0,0x1
      a6:	2de50513          	add	a0,a0,734 # 1380 <malloc+0x108>
    ...
    printf("grind: chdir grindir failed\n");
      ...
      c0:	2cc50513          	add	a0,a0,716 # 1388 <malloc+0x110>
  ...
  chdir("/");
      ...
      e2:	2ca50513          	add	a0,a0,714 # 13a8 <malloc+0x130>
      e6:	00001097          	auipc	ra,0x1
      ea:	dca080e7          	jalr	-566(ra) # eb0 <chdir>
      ee:	00001997          	auipc	s3,0x1
      f2:	2ca98993          	add	s3,s3,714 # 13b8 <malloc+0x140>
      f6:	c489                	beqz	s1,100 <go+0x88>
      f8:	00001997          	auipc	s3,0x1
      fc:	2b898993          	add	s3,s3,696 # 13b0 <malloc+0x138>
  uint64 iters = 0;
     100:	4481                	li	s1,0
  int fd = -1;
     102:	5a7d                	li	s4,-1
     104:	00001917          	auipc	s2,0x1
     108:	56490913          	add	s2,s2,1380 # 1668 <malloc+0x3f0>
    ...
    if(what == 1){
     ...
     116:	2ae50513          	add	a0,a0,686 # 13c0 <malloc+0x148>
    ...
    int what = rand() % 23;
     ...
     174:	26050513          	add	a0,a0,608 # 13d0 <malloc+0x158>
     ...
     18e:	23650513          	add	a0,a0,566 # 13c0 <malloc+0x148>
     ...
     1a0:	1e450513          	add	a0,a0,484 # 1380 <malloc+0x108>
     ...
     1fc:	1f850513          	add	a0,a0,504 # 13f0 <malloc+0x178>
     ...
     21e:	1e650513          	add	a0,a0,486 # 1400 <malloc+0x188>
     ...
     28e:	19e50513          	add	a0,a0,414 # 1428 <malloc+0x1b0>
     ...
     2cc:	18050513          	add	a0,a0,384 # 1448 <malloc+0x1d0>
     ...
     2de:	13650513          	add	a0,a0,310 # 1410 <malloc+0x198>
     2e2:	00001097          	auipc	ra,0x1
     2e6:	bae080e7          	jalr	-1106(ra) # e90 <unlink>
      link("../grindir/./../a", "../b");
     2ea:	00001597          	auipc	a1,0x1
     2ee:	0fe58593          	add	a1,a1,254 # 13e8 <malloc+0x170>
     2f2:	00001517          	auipc	a0,0x1
     2f6:	15e50513          	add	a0,a0,350 # 1450 <malloc+0x1d8>
     ...
     308:	16450513          	add	a0,a0,356 # 1468 <malloc+0x1f0>
     30c:	00001097          	auipc	ra,0x1
     310:	b84080e7          	jalr	-1148(ra) # e90 <unlink>
      link(".././b", "/grindir/../a");
     314:	00001597          	auipc	a1,0x1
     318:	0dc58593          	add	a1,a1,220 # 13f0 <malloc+0x178>
     31c:	00001517          	auipc	a0,0x1
     320:	15c50513          	add	a0,a0,348 # 1478 <malloc+0x200>
     ...
     354:	13050513          	add	a0,a0,304 # 1480 <malloc+0x208>
     ...
     3a2:	0e250513          	add	a0,a0,226 # 1480 <malloc+0x208>
     ...
     402:	09a50513          	add	a0,a0,154 # 1498 <malloc+0x220>
     ...
     42e:	03650513          	add	a0,a0,54 # 1460 <malloc+0x1e8>
     ...
     450:	03450513          	add	a0,a0,52 # 1480 <malloc+0x208>
     ...
     46a:	04250513          	add	a0,a0,66 # 14a8 <malloc+0x230>
     ...
     4b8:	fcc50513          	add	a0,a0,-52 # 1480 <malloc+0x208>
     ...
     514:	fb050513          	add	a0,a0,-80 # 14c0 <malloc+0x248>
     ...
     540:	f9c58593          	add	a1,a1,-100 # 14d8 <malloc+0x260>
     ...
     642:	e4250513          	add	a0,a0,-446 # 1480 <malloc+0x208>
     ...
     65c:	ec850513          	add	a0,a0,-312 # 1520 <malloc+0x2a8>
     ...
     670:	eb450513          	add	a0,a0,-332 # 1520 <malloc+0x2a8>
     ...
     688:	e5458593          	add	a1,a1,-428 # 14d8 <malloc+0x260>
     ...
     6ce:	e5650513          	add	a0,a0,-426 # 1520 <malloc+0x2a8>
     6d2:	00000097          	auipc	ra,0x0
     6d6:	7be080e7          	jalr	1982(ra) # e90 <unlink>
     6da:	bc81                	j	12a <go+0xb2>
        printf("grind: create c failed\n");
     6dc:	00001517          	auipc	a0,0x1
     6e0:	e4c50513          	add	a0,a0,-436 # 1528 <malloc+0x2b0>
     ...
     6fa:	e4a50513          	add	a0,a0,-438 # 1540 <malloc+0x2c8>
     ...
     714:	e4850513          	add	a0,a0,-440 # 1558 <malloc+0x2e0>
     ...
     730:	e4450513          	add	a0,a0,-444 # 1570 <malloc+0x2f8>
     ...
     74a:	e5250513          	add	a0,a0,-430 # 1598 <malloc+0x320>
     ...
     832:	e0a58593          	add	a1,a1,-502 # 1638 <malloc+0x3c0>
     ...
     856:	dee50513          	add	a0,a0,-530 # 1640 <malloc+0x3c8>
     ...
     870:	c5458593          	add	a1,a1,-940 # 14c0 <malloc+0x248>
     874:	4509                	li	a0,2
     ...
     88c:	c3858593          	add	a1,a1,-968 # 14c0 <malloc+0x248>
     890:	4509                	li	a0,2
     ...
     8e8:	cdc58593          	add	a1,a1,-804 # 15c0 <malloc+0x348>
     8ec:	4509                	li	a0,2
     ...
     95c:	b2858593          	add	a1,a1,-1240 # 1480 <malloc+0x208>
     960:	4509                	li	a0,2
     ...
     9a8:	c1c58593          	add	a1,a1,-996 # 15c0 <malloc+0x348>
     9ac:	4509                	li	a0,2
     ...
     9ec:	bd858593          	add	a1,a1,-1064 # 15c0 <malloc+0x348>
     9f0:	4509                	li	a0,2
     ...
     a54:	a3058593          	add	a1,a1,-1488 # 1480 <malloc+0x208>
     a58:	4509                	li	a0,2
...
iter()
{
  ...
  unlink("a");
     ...
     a78:	9ec50513          	add	a0,a0,-1556 # 1460 <malloc+0x1e8>
     a7c:	00000097          	auipc	ra,0x0
     a80:	414080e7          	jalr	1044(ra) # e90 <unlink>
  unlink("b");
     a84:	00001517          	auipc	a0,0x1
     a88:	98c50513          	add	a0,a0,-1652 # 1410 <malloc+0x198>
  ...
  if(pid1 == 0){
    ...
    printf("grind: fork failed\n");
     ...
     aca:	9ba50513          	add	a0,a0,-1606 # 1480 <malloc+0x208>
  ...
  if(pid2 == 0){
    ...
    printf("grind: fork failed\n");
     ...
     b14:	97050513          	add	a0,a0,-1680 # 1480 <malloc+0x208>
...
0000000000000ef0 <getschedhistory>:
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     f3c:	7f050513          	add	a0,a0,2032 # 1728 <digits>
     f40:	883a                	mv	a6,a4
  ...
  while(--i >= 0)
     ...
     f84:	fc040793          	add	a5,s0,-64
     f88:	00e78933          	add	s2,a5,a4
     f8c:	fff78993          	add	s3,a5,-1
     f90:	99ba                	add	s3,s3,a4
     f92:	377d                	addw	a4,a4,-1
     f94:	1702                	sll	a4,a4,0x20
     f96:	9301                	srl	a4,a4,0x20
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    1042:	69270713          	add	a4,a4,1682 # 16d0 <malloc+0x458>
  ...
  putc(fd, 'x');
    ...
    10ce:	65eb8b93          	add	s7,s7,1630 # 1728 <digits>
    10d2:	03c9d793          	srl	a5,s3,0x3c
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    10e6:	0992                	sll	s3,s3,0x4
    10e8:	397d                	addw	s2,s2,-1
    ...
    1124:	5a890913          	add	s2,s2,1448 # 16c8 <malloc+0x450>
        while(*s != 0){
...
{
    1192:	715d                	add	sp,sp,-80
    1194:	ec06                	sd	ra,24(sp)
    1196:	e822                	sd	s0,16(sp)
    1198:	1000                	add	s0,sp,32
...
{
    11c0:	711d                	add	sp,sp,-96
    11c2:	ec06                	sd	ra,24(sp)
    11c4:	e822                	sd	s0,16(sp)
    11c6:	1000                	add	s0,sp,32
...
free(void *ap)
{
    11f6:	1141                	add	sp,sp,-16
    11f8:	e422                	sd	s0,8(sp)
    11fa:	0800                	add	s0,sp,16
  Header *bp, *p;

  bp = (Header*)ap - 1;
    11fc:	ff050693          	add	a3,a0,-16
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    1200:	00001797          	auipc	a5,0x1
    1204:	2a07b783          	ld	a5,672(a5) # 24a0 <freep>
    ...
    122c:	00e6ea63          	bltu	a3,a4,1240 <free+0x4a>
{
  ...
  if(bp + bp->s.size == p->s.ptr){
    ...
    1246:	02059813          	sll	a6,a1,0x20
    124a:	01c85713          	srl	a4,a6,0x1c
  ...
  if(p + p->s.size == bp){
    ...
    125a:	02061593          	sll	a1,a2,0x20
    125e:	01c5d713          	srl	a4,a1,0x1c
  ...
  freep = p;
    ...
    126e:	22f73b23          	sd	a5,566(a4) # 24a0 <freep>
}
    1272:	6422                	ld	s0,8(sp)
    1274:	0141                	add	sp,sp,16
    1276:	8082                	ret
...
malloc(uint nbytes)
{
    1278:	7139                	add	sp,sp,-64
    127a:	fc06                	sd	ra,56(sp)
    127c:	f822                	sd	s0,48(sp)
    127e:	f426                	sd	s1,40(sp)
    1280:	ec4e                	sd	s3,24(sp)
    1282:	0080                	add	s0,sp,64
  Header *p, *prevp;
  uint nunits;

  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    1284:	02051493          	sll	s1,a0,0x20
    1288:	9081                	srl	s1,s1,0x20
    128a:	04bd                	add	s1,s1,15
    128c:	8091                	srl	s1,s1,0x4
    128e:	0014899b          	addw	s3,s1,1
    1292:	0485                	add	s1,s1,1
  if((prevp = freep) == 0){
    1294:	00001517          	auipc	a0,0x1
    1298:	20c53503          	ld	a0,524(a0) # 24a0 <freep>
    129c:	c915                	beqz	a0,12d0 <malloc+0x58>
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    12a2:	08977e63          	bgeu	a4,s1,133e <malloc+0xc6>
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    12c8:	1dc90913          	add	s2,s2,476 # 24a0 <freep>
  if(p == (char*)-1)
    12cc:	5afd                	li	s5,-1
    12ce:	a091                	j	1312 <malloc+0x9a>
    ...
    12dc:	5c078793          	add	a5,a5,1472 # 2898 <base>
    12e0:	00001717          	auipc	a4,0x1
    12e4:	1cf73023          	sd	a5,448(a4) # 24a0 <freep>
    12e8:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
    12ea:	0007a423          	sw	zero,8(a5)
    if(p->s.size >= nunits){
    12ee:	b7c1                	j	12ae <malloc+0x36>
        prevp->s.ptr = p->s.ptr;
    12f0:	6398                	ld	a4,0(a5)
    12f2:	e118                	sd	a4,0(a0)
    12f4:	a08d                	j	1356 <malloc+0xde>
  hp->s.size = nu;
    12f6:	01652423          	sw	s6,8(a0)
  free((void*)(hp + 1));
    12fa:	0541                	add	a0,a0,16
    12fc:	00000097          	auipc	ra,0x0
    1300:	efa080e7          	jalr	-262(ra) # 11f6 <free>
  return freep;
    1304:	00093503          	ld	a0,0(s2)
      if((p = morecore(nunits)) == 0)
    1308:	c13d                	beqz	a0,136e <malloc+0xf6>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    130a:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    130c:	4798                	lw	a4,8(a5)
    130e:	02977463          	bgeu	a4,s1,1336 <malloc+0xbe>
    if(p == freep)
    1312:	00093703          	ld	a4,0(s2)
    1316:	853e                	mv	a0,a5
    1318:	fef719e3          	bne	a4,a5,130a <malloc+0x92>
  p = sbrk(nu * sizeof(Header));
    131c:	8552                	mv	a0,s4
    131e:	00000097          	auipc	ra,0x0
    1322:	baa080e7          	jalr	-1110(ra) # ec8 <sbrk>
  if(p == (char*)-1)
    1326:	fd5518e3          	bne	a0,s5,12f6 <malloc+0x7e>
        return 0;
    132a:	4501                	li	a0,0
    ...
    1334:	a03d                	j	1362 <malloc+0xea>
    1336:	7902                	ld	s2,32(sp)
    1338:	6a42                	ld	s4,16(sp)
    133a:	6aa2                	ld	s5,8(sp)
    133c:	6b02                	ld	s6,0(sp)
      if(p->s.size == nunits)
    133e:	fae489e3          	beq	s1,a4,12f0 <malloc+0x78>
        p->s.size -= nunits;
    1342:	4137073b          	subw	a4,a4,s3
    1346:	c798                	sw	a4,8(a5)
        p += p->s.size;
    1348:	02071693          	sll	a3,a4,0x20
    134c:	01c6d713          	srl	a4,a3,0x1c
    1350:	97ba                	add	a5,a5,a4
        p->s.size = nunits;
    1352:	0137a423          	sw	s3,8(a5)
      freep = prevp;
    1356:	00001717          	auipc	a4,0x1
    135a:	14a73523          	sd	a0,330(a4) # 24a0 <freep>
      return (void*)(p + 1);
    135e:	01078513          	add	a0,a5,16
  }
}
    1362:	70e2                	ld	ra,56(sp)
    1364:	7442                	ld	s0,48(sp)
    1366:	74a2                	ld	s1,40(sp)
    1368:	69e2                	ld	s3,24(sp)
    136a:	6121                	add	sp,sp,64
    136c:	8082                	ret
    136e:	7902                	ld	s2,32(sp)
    1370:	6a42                	ld	s4,16(sp)
    1372:	6aa2                	ld	s5,8(sp)
    1374:	6b02                	ld	s6,0(sp)
    1376:	b7f5                	j	1362 <malloc+0xea>
