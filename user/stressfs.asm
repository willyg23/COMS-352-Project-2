...
main(int argc, char *argv[])
{
  ...
  1a:	8ea78793          	add	a5,a5,-1814 # 900 <malloc+0x136>
  1e:	6398                	ld	a4,0(a5)
  ...
  30:	8a450513          	add	a0,a0,-1884 # 8d0 <malloc+0x106>
  ...
  6c:	88050513          	add	a0,a0,-1920 # 8e8 <malloc+0x11e>
...
//    printf(fd, "%d\n", i);
  ...
  ba:	84250513          	add	a0,a0,-1982 # 8f8 <malloc+0x12e>
...
0000000000000442 <getschedhistory>:
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 48e:	4e650513          	add	a0,a0,1254 # 970 <digits>
 492:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 594:	38870713          	add	a4,a4,904 # 918 <malloc+0x14e>
 ...
 620:	354b8b93          	add	s7,s7,852 # 970 <digits>
 ...
 676:	29e90913          	add	s2,s2,670 # 910 <malloc+0x146>
        while(*s != 0){
...
free(void *ap)
{
 ...
 756:	c8e7b783          	ld	a5,-882(a5) # 13e0 <freep>
...
malloc(uint nbytes)
{
 ...
 7ea:	bfa53503          	ld	a0,-1030(a0) # 13e0 <freep>
 ...
 812:	004a1a1b          	sllw	s4,s4,0x4
    ...
    if(p == freep)
 816:	00001917          	auipc	s2,0x1
 81a:	bca90913          	add	s2,s2,-1078 # 13e0 <freep>
  if(p == (char*)-1)
 81e:	5afd                	li	s5,-1
 ...
 82e:	bc678793          	add	a5,a5,-1082 # 13f0 <base>
 832:	00001717          	auipc	a4,0x1
 836:	baf73723          	sd	a5,-1106(a4) # 13e0 <freep>
 83a:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 874:	baa080e7          	jalr	-1110(ra) # 41a <sbrk>
  if(p == (char*)-1)
 ...
 898:	c798                	sw	a4,8(a5)
        p += p->s.size;
 89a:	02071693          	sll	a3,a4,0x20
 89e:	01c6d713          	srl	a4,a3,0x1c
 8a2:	97ba                	add	a5,a5,a4
        p->s.size = nunits;
 8a4:	0137a423          	sw	s3,8(a5)
      freep = prevp;
 8a8:	00001717          	auipc	a4,0x1
 8ac:	b2a73c23          	sd	a0,-1224(a4) # 13e0 <freep>
      return (void*)(p + 1);
 8b0:	01078513          	add	a0,a5,16
  }
}
