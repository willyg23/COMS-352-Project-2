...
getcmd(char *buf, int nbuf)
{
  ...
  write(2, "$ ", 2);
      ...
      16:	31e58593          	add	a1,a1,798 # 1330 <malloc+0x108>
      1a:	4509                	li	a0,2
...
panic(char *s)
{
  ...
  fprintf(2, "%s\n", s);
      ...
      64:	2d858593          	add	a1,a1,728 # 1338 <malloc+0x110>
      68:	4509                	li	a0,2
...
fork1(void)
{
  ...
  return pid;
    ...
    panic("fork");
      ...
      9e:	2a650513          	add	a0,a0,678 # 1340 <malloc+0x118>
...
00000000000000aa <runcmd>:
{
  ...
  switch(cmd->type){
      ...
      ca:	37a70713          	add	a4,a4,890 # 1440 <malloc+0x218>
    ...
    panic("runcmd");
      ...
      e6:	26650513          	add	a0,a0,614 # 1348 <malloc+0x120>
    ...
    fprintf(2, "exec %s failed\n", ecmd->argv[0]);
     ...
     108:	24c58593          	add	a1,a1,588 # 1350 <malloc+0x128>
     10c:	4509                	li	a0,2
  ...
  exit(0);
    ...
    runcmd(rcmd->cmd);
     ...
     154:	21058593          	add	a1,a1,528 # 1360 <malloc+0x138>
     158:	4509                	li	a0,2
    ...
    if(fork1() == 0){
     ...
     1ea:	18a50513          	add	a0,a0,394 # 1370 <malloc+0x148>
...
execcmd(void)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     28c:	fa0080e7          	jalr	-96(ra) # 1228 <malloc>
     290:	84aa                	mv	s1,a0
...
redircmd(struct cmd *subcmd, char *file, char *efile, int mode, int fd)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     2d6:	f56080e7          	jalr	-170(ra) # 1228 <malloc>
     2da:	84aa                	mv	s1,a0
  memset(cmd, 0, sizeof(*cmd));
...
pipecmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     330:	efc080e7          	jalr	-260(ra) # 1228 <malloc>
     334:	84aa                	mv	s1,a0
  memset(cmd, 0, sizeof(*cmd));
     336:	4661                	li	a2,24
     338:	4581                	li	a1,0
...
listcmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     376:	eb6080e7          	jalr	-330(ra) # 1228 <malloc>
     37a:	84aa                	mv	s1,a0
  memset(cmd, 0, sizeof(*cmd));
     37c:	4661                	li	a2,24
     37e:	4581                	li	a1,0
...
backcmd(struct cmd *subcmd)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     3b8:	e74080e7          	jalr	-396(ra) # 1228 <malloc>
     3bc:	84aa                	mv	s1,a0
  memset(cmd, 0, sizeof(*cmd));
     3be:	4641                	li	a2,16
     3c0:	4581                	li	a1,0
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     ...
     5b8:	de4a8a93          	add	s5,s5,-540 # 1398 <malloc+0x170>
  ...
  while(peek(ps, es, "<>")){
     ...
     5ca:	db250513          	add	a0,a0,-590 # 1378 <malloc+0x150>
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     ...
     6a2:	d0260613          	add	a2,a2,-766 # 13a0 <malloc+0x178>
  ...
  while(!peek(ps, es, "|)&;")){
     ...
     6de:	ce6b0b13          	add	s6,s6,-794 # 13c0 <malloc+0x198>
  ...
  return ret;
     ...
     70c:	ca050513          	add	a0,a0,-864 # 13a8 <malloc+0x180>
  ...
  while(!peek(ps, es, "|)&;")){
    ...
    if(argc >= MAXARGS)
     ...
     76e:	c4650513          	add	a0,a0,-954 # 13b0 <malloc+0x188>
...
0000000000000794 <parsepipe>:
{
  ...
  if(peek(ps, es, "|")){
     ...
     7b4:	c1860613          	add	a2,a2,-1000 # 13c8 <malloc+0x1a0>
     7b8:	85ce                	mv	a1,s3
     7ba:	854a                	mv	a0,s2
...
0000000000000802 <parseline>:
{
  ...
  while(peek(ps, es, "&")){
     ...
     824:	bb0a0a13          	add	s4,s4,-1104 # 13d0 <malloc+0x1a8>
  ...
  if(peek(ps, es, ";")){
     ...
     85a:	b8260613          	add	a2,a2,-1150 # 13d8 <malloc+0x1b0>
     85e:	85ce                	mv	a1,s3
     860:	854a                	mv	a0,s2
...
00000000000008aa <parseblock>:
{
  ...
  if(!peek(ps, es, "("))
     ...
     8c0:	ae460613          	add	a2,a2,-1308 # 13a0 <malloc+0x178>
  ...
  if(!peek(ps, es, ")"))
     ...
     8f0:	b0460613          	add	a2,a2,-1276 # 13f0 <malloc+0x1c8>
     8f4:	85ca                	mv	a1,s2
     8f6:	8526                	mv	a0,s1
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     96e:	aee70713          	add	a4,a4,-1298 # 1458 <malloc+0x230>
...
00000000000009e6 <parsecmd>:
{
  ...
  peek(&s, es, "");
     ...
     a1a:	9fa60613          	add	a2,a2,-1542 # 1410 <malloc+0x1e8>
     a1e:	85a6                	mv	a1,s1
  ...
  nulterminate(cmd);
    ...
    fprintf(2, "leftovers: %s\n", s);
     ...
     a50:	9cc58593          	add	a1,a1,-1588 # 1418 <malloc+0x1f0>
     a54:	4509                	li	a0,2
     a56:	00000097          	auipc	ra,0x0
     a5a:	6ec080e7          	jalr	1772(ra) # 1142 <fprintf>
    panic("syntax");
     a5e:	00001517          	auipc	a0,0x1
     a62:	94a50513          	add	a0,a0,-1718 # 13a8 <malloc+0x180>
...
0000000000000a6e <main>:
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
     ...
     a82:	9aa48493          	add	s1,s1,-1622 # 1428 <malloc+0x200>
     a86:	4589                	li	a1,2
     a88:	8526                	mv	a0,s1
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    ...
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     ...
     b38:	8fc58593          	add	a1,a1,-1796 # 1430 <malloc+0x208>
     b3c:	4509                	li	a0,2
...
0000000000000ea0 <getschedhistory>:
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     eec:	5e850513          	add	a0,a0,1512 # 14d0 <digits>
     ef0:	883a                	mv	a6,a4
     ef2:	2705                	addw	a4,a4,1
     ef4:	02c5f7bb          	remuw	a5,a1,a2
     ef8:	1782                	sll	a5,a5,0x20
     efa:	9381                	srl	a5,a5,0x20
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    if(state == 0){
     ...
     ff2:	48a70713          	add	a4,a4,1162 # 1478 <malloc+0x250>
  ...
  putc(fd, 'x');
    ...
    107e:	456b8b93          	add	s7,s7,1110 # 14d0 <digits>
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    10d4:	3a090913          	add	s2,s2,928 # 1470 <malloc+0x248>
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    ...
    11b4:	6307b783          	ld	a5,1584(a5) # 27e0 <freep>
    ...
    11dc:	00e6ea63          	bltu	a3,a4,11f0 <free+0x4a>
{
  ...
  freep = p;
    ...
    121e:	5cf73323          	sd	a5,1478(a4) # 27e0 <freep>
}
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    1244:	00001517          	auipc	a0,0x1
    1248:	59c53503          	ld	a0,1436(a0) # 27e0 <freep>
    124c:	c915                	beqz	a0,1280 <malloc+0x58>
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    1252:	08977e63          	bgeu	a4,s1,12ee <malloc+0xc6>
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    1278:	56c90913          	add	s2,s2,1388 # 27e0 <freep>
  if(p == (char*)-1)
    127c:	5afd                	li	s5,-1
    127e:	a091                	j	12c2 <malloc+0x9a>
    ...
    128c:	5d078793          	add	a5,a5,1488 # 2858 <base>
    1290:	00001717          	auipc	a4,0x1
    1294:	54f73823          	sd	a5,1360(a4) # 27e0 <freep>
    1298:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
    129a:	0007a423          	sw	zero,8(a5)
    if(p->s.size >= nunits){
    129e:	b7c1                	j	125e <malloc+0x36>
        prevp->s.ptr = p->s.ptr;
    12a0:	6398                	ld	a4,0(a5)
    12a2:	e118                	sd	a4,0(a0)
    12a4:	a08d                	j	1306 <malloc+0xde>
  hp->s.size = nu;
    12a6:	01652423          	sw	s6,8(a0)
  free((void*)(hp + 1));
    12aa:	0541                	add	a0,a0,16
    12ac:	00000097          	auipc	ra,0x0
    12b0:	efa080e7          	jalr	-262(ra) # 11a6 <free>
  return freep;
    12b4:	00093503          	ld	a0,0(s2)
      if((p = morecore(nunits)) == 0)
    12b8:	c13d                	beqz	a0,131e <malloc+0xf6>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    12ba:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    12bc:	4798                	lw	a4,8(a5)
    12be:	02977463          	bgeu	a4,s1,12e6 <malloc+0xbe>
    if(p == freep)
    12c2:	00093703          	ld	a4,0(s2)
    12c6:	853e                	mv	a0,a5
    12c8:	fef719e3          	bne	a4,a5,12ba <malloc+0x92>
  p = sbrk(nu * sizeof(Header));
    12cc:	8552                	mv	a0,s4
    12ce:	00000097          	auipc	ra,0x0
    12d2:	baa080e7          	jalr	-1110(ra) # e78 <sbrk>
  if(p == (char*)-1)
    12d6:	fd5518e3          	bne	a0,s5,12a6 <malloc+0x7e>
        return 0;
    12da:	4501                	li	a0,0
