...
main(int argc, char *argv[])
{
  ...
  14:	81058593          	add	a1,a1,-2032 # 820 <malloc+0x100>
  18:	4509                	li	a0,2
  ...
  52:	7ea58593          	add	a1,a1,2026 # 838 <malloc+0x118>
  56:	4509                	li	a0,2
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3e4:	4d050513          	add	a0,a0,1232 # 8b0 <digits>
 3e8:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4ea:	37270713          	add	a4,a4,882 # 858 <malloc+0x138>
 ...
 576:	33eb8b93          	add	s7,s7,830 # 8b0 <digits>
 ...
 5cc:	28890913          	add	s2,s2,648 # 850 <malloc+0x130>
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 770:	c7490913          	add	s2,s2,-908 # 13e0 <freep>
  if(p == (char*)-1)
 774:	5afd                	li	s5,-1
 ...
 784:	c7078793          	add	a5,a5,-912 # 13f0 <base>
 ...
 7ca:	baa080e7          	jalr	-1110(ra) # 370 <sbrk>
  if(p == (char*)-1)
