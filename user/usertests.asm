...
copyinstr1(char *s)
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    uint64 addr = addrs[ai];
      ...
      42:	10250513          	add	a0,a0,258 # 6140 <malloc+0x10c>
...
bsstest(char *s)
{
  ...
  for(i = 0; i < sizeof(uninit); i++){
      ...
      5c:	89078793          	add	a5,a5,-1904 # b8e8 <uninit>
      60:	0000e697          	auipc	a3,0xe
      64:	f9868693          	add	a3,a3,-104 # dff8 <buf>
    if(uninit[i] != '\0'){
      ...
      74:	8082                	ret
{
      ...
      84:	0e050513          	add	a0,a0,224 # 6160 <malloc+0x12c>
...
000000000000009a <opentest>:
{
  ...
  fd = open("echo", 0);
      ...
      ac:	0d050513          	add	a0,a0,208 # 6178 <malloc+0x144>
  ...
  fd = open("doesnotexist", 0);
      ...
      ca:	0d250513          	add	a0,a0,210 # 6198 <malloc+0x164>
  ...
  if(fd >= 0){
    ...
    printf("%s: open echo failed!\n", s);
      ...
      ea:	09a50513          	add	a0,a0,154 # 6180 <malloc+0x14c>
    ...
    printf("%s: open doesnotexist succeeded!\n", s);
     ...
     106:	0a650513          	add	a0,a0,166 # 61a8 <malloc+0x174>
...
000000000000011c <truncate2>:
{
  ...
  unlink("truncfile");
     ...
     130:	0a450513          	add	a0,a0,164 # 61d0 <malloc+0x19c>
     134:	00006097          	auipc	ra,0x6
     138:	b18080e7          	jalr	-1256(ra) # 5c4c <unlink>
  int fd1 = open("truncfile", O_CREATE|O_TRUNC|O_WRONLY);
     13c:	60100593          	li	a1,1537
     140:	00006517          	auipc	a0,0x6
     144:	09050513          	add	a0,a0,144 # 61d0 <malloc+0x19c>
  ...
  write(fd1, "abcd", 4);
     ...
     158:	08c58593          	add	a1,a1,140 # 61e0 <malloc+0x1ac>
     15c:	00006097          	auipc	ra,0x6
     160:	ac0080e7          	jalr	-1344(ra) # 5c1c <write>
  int fd2 = open("truncfile", O_TRUNC|O_WRONLY);
     164:	40100593          	li	a1,1025
     168:	00006517          	auipc	a0,0x6
     16c:	06850513          	add	a0,a0,104 # 61d0 <malloc+0x19c>
  ...
  int n = write(fd1, "x", 1);
     ...
     180:	06c58593          	add	a1,a1,108 # 61e8 <malloc+0x1b4>
     184:	8526                	mv	a0,s1
  ...
  unlink("truncfile");
     ...
     198:	03c50513          	add	a0,a0,60 # 61d0 <malloc+0x19c>
  ...
  close(fd2);
    ...
    printf("%s: write returned %d, expected -1\n", s, n);
     ...
     1ce:	02650513          	add	a0,a0,38 # 61f0 <malloc+0x1bc>
...
0000000000000264 <bigwrite>:
{
  ...
  unlink("bigwrite");
     ...
     280:	f9c50513          	add	a0,a0,-100 # 6218 <malloc+0x1e4>
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
    ...
    fd = open("bigwrite", O_CREATE | O_RDWR);
     ...
     294:	f88a8a93          	add	s5,s5,-120 # 6218 <malloc+0x1e4>
      int cc = write(fd, buf, sz);
     298:	0000ea17          	auipc	s4,0xe
     29c:	d60a0a13          	add	s4,s4,-672 # dff8 <buf>
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     2a0:	6b0d                	lui	s6,0x3
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     ...
     316:	f1650513          	add	a0,a0,-234 # 6228 <malloc+0x1f4>
     ...
     338:	f1450513          	add	a0,a0,-236 # 6248 <malloc+0x214>
...
badwrite(char *s)
{
  ...
  unlink("junk");
     ...
     362:	f0250513          	add	a0,a0,-254 # 6260 <malloc+0x22c>
  ...
  for(int i = 0; i < assumed_free; i++){
    int fd = open("junk", O_CREATE|O_WRONLY);
     ...
     376:	eee98993          	add	s3,s3,-274 # 6260 <malloc+0x22c>
    if(fd < 0){
  ...
  int fd = open("junk", O_CREATE|O_WRONLY);
     ...
     3c2:	ea250513          	add	a0,a0,-350 # 6260 <malloc+0x22c>
  ...
  if(write(fd, "x", 1) != 1){
     ...
     3da:	e1258593          	add	a1,a1,-494 # 61e8 <malloc+0x1b4>
    ...
    printf("write failed\n");
     ...
     3f0:	e9450513          	add	a0,a0,-364 # 6280 <malloc+0x24c>
    ...
    exit(1);
     ...
     40a:	e6250513          	add	a0,a0,-414 # 6268 <malloc+0x234>
    ...
    printf("open junk failed\n");
     ...
     424:	e4850513          	add	a0,a0,-440 # 6268 <malloc+0x234>
  ...
  unlink("junk");
     ...
     448:	e1c50513          	add	a0,a0,-484 # 6260 <malloc+0x22c>
...
000000000000052e <copyin>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("copyin1", O_CREATE|O_WRONLY);
     ...
     554:	d40a0a13          	add	s4,s4,-704 # 6290 <malloc+0x25c>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     600:	c9c50513          	add	a0,a0,-868 # 6298 <malloc+0x264>
     ...
     61e:	c9650513          	add	a0,a0,-874 # 62b0 <malloc+0x27c>
     ...
     63c:	ca850513          	add	a0,a0,-856 # 62e0 <malloc+0x2ac>
     ...
     656:	cbe50513          	add	a0,a0,-834 # 6310 <malloc+0x2dc>
     ...
     674:	cb050513          	add	a0,a0,-848 # 6320 <malloc+0x2ec>
...
000000000000068a <copyout>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("README", 0);
     ...
     6b2:	ca2a0a13          	add	s4,s4,-862 # 6350 <malloc+0x31c>
    n = write(fds[1], "x", 1);
     6b6:	00006a97          	auipc	s5,0x6
     6ba:	b32a8a93          	add	s5,s5,-1230 # 61e8 <malloc+0x1b4>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     760:	bfc50513          	add	a0,a0,-1028 # 6358 <malloc+0x324>
     ...
     77e:	bf650513          	add	a0,a0,-1034 # 6370 <malloc+0x33c>
     ...
     798:	b7c50513          	add	a0,a0,-1156 # 6310 <malloc+0x2dc>
     ...
     7b2:	bf250513          	add	a0,a0,-1038 # 63a0 <malloc+0x36c>
     ...
     7d0:	bec50513          	add	a0,a0,-1044 # 63b8 <malloc+0x384>
...
00000000000007e6 <truncate1>:
{
  ...
  write(fd1, "abcd", 4);
     ...
     826:	9be58593          	add	a1,a1,-1602 # 61e0 <malloc+0x1ac>
  ...
  int fd2 = open("truncfile", O_RDONLY);
     ...
     842:	99250513          	add	a0,a0,-1646 # 61d0 <malloc+0x19c>
  ...
  fd1 = open("truncfile", O_WRONLY|O_TRUNC);
     ...
     86e:	96650513          	add	a0,a0,-1690 # 61d0 <malloc+0x19c>
  ...
  int fd3 = open("truncfile", O_RDONLY);
     ...
     882:	95250513          	add	a0,a0,-1710 # 61d0 <malloc+0x19c>
  ...
  write(fd1, "abcdef", 6);
     ...
     8c0:	b8c58593          	add	a1,a1,-1140 # 6448 <malloc+0x414>
     8c4:	854e                	mv	a0,s3
  ...
  unlink("truncfile");
     ...
     902:	8d250513          	add	a0,a0,-1838 # 61d0 <malloc+0x19c>
  ...
  close(fd3);
    ...
    printf("%s: read %d bytes, wanted 4\n", s, n);
     ...
     946:	aa650513          	add	a0,a0,-1370 # 63e8 <malloc+0x3b4>
    ...
    printf("aaa fd3=%d\n", fd3);
     ...
     962:	aaa50513          	add	a0,a0,-1366 # 6408 <malloc+0x3d4>
    ...
    printf("%s: read %d bytes, wanted 0\n", s, n);
     ...
     976:	aa650513          	add	a0,a0,-1370 # 6418 <malloc+0x3e4>
    ...
    printf("bbb fd2=%d\n", fd2);
     ...
     992:	aaa50513          	add	a0,a0,-1366 # 6438 <malloc+0x404>
    ...
    printf("%s: read %d bytes, wanted 0\n", s, n);
     ...
     9a6:	a7650513          	add	a0,a0,-1418 # 6418 <malloc+0x3e4>
    ...
    printf("%s: read %d bytes, wanted 6\n", s, n);
     ...
     9c4:	a9050513          	add	a0,a0,-1392 # 6450 <malloc+0x41c>
    ...
    printf("%s: read %d bytes, wanted 2\n", s, n);
     ...
     9e2:	a9250513          	add	a0,a0,-1390 # 6470 <malloc+0x43c>
...
00000000000009f8 <writetest>:
{
  ...
  fd = open("small", O_CREATE|O_RDWR);
     ...
     a16:	a7e50513          	add	a0,a0,-1410 # 6490 <malloc+0x45c>
  ...
  if(fd < 0){
    ...
    if(write(fd, "aaaaaaaaaa", SZ) != SZ){
     ...
     a2e:	a8e98993          	add	s3,s3,-1394 # 64b8 <malloc+0x484>
    if(write(fd, "bbbbbbbbbb", SZ) != SZ){
     a32:	00006a97          	auipc	s5,0x6
     a36:	abea8a93          	add	s5,s5,-1346 # 64f0 <malloc+0x4bc>
  for(i = 0; i < N; i++){
  ...
  fd = open("small", O_RDONLY);
     ...
     a7c:	a1850513          	add	a0,a0,-1512 # 6490 <malloc+0x45c>
  ...
  i = read(fd, buf, N*SZ*2);
     ...
     a96:	56658593          	add	a1,a1,1382 # dff8 <buf>
  ...
  if(unlink("small") < 0){
     ...
     ab8:	9dc50513          	add	a0,a0,-1572 # 6490 <malloc+0x45c>
    ...
    printf("%s: error: creat small failed!\n", s);
     ...
     ae2:	9ba50513          	add	a0,a0,-1606 # 6498 <malloc+0x464>
    ...
    exit(1);
     ...
     b00:	9cc50513          	add	a0,a0,-1588 # 64c8 <malloc+0x494>
     ...
     b1e:	9e650513          	add	a0,a0,-1562 # 6500 <malloc+0x4cc>
    ...
    printf("%s: error: open small failed!\n", s);
     ...
     b3a:	9f250513          	add	a0,a0,-1550 # 6528 <malloc+0x4f4>
    ...
    printf("%s: read failed\n", s);
     ...
     b56:	9f650513          	add	a0,a0,-1546 # 6548 <malloc+0x514>
    ...
    printf("%s: unlink small failed\n", s);
     ...
     b72:	9f250513          	add	a0,a0,-1550 # 6560 <malloc+0x52c>
...
0000000000000b88 <writebig>:
{
  ...
  fd = open("big", O_CREATE|O_RDWR);
     ...
     ba4:	9e050513          	add	a0,a0,-1568 # 6580 <malloc+0x54c>
  ...
  for(i = 0; i < MAXFILE; i++){
    ...
    ((int*)buf)[0] = i;
     ...
     bb8:	44490913          	add	s2,s2,1092 # dff8 <buf>
  for(i = 0; i < MAXFILE; i++){
  ...
  fd = open("big", O_RDONLY);
     ...
     bf6:	98e50513          	add	a0,a0,-1650 # 6580 <malloc+0x54c>
  ...
  n = 0;
    ...
    i = read(fd, buf, BSIZE);
     ...
     c0a:	3f290913          	add	s2,s2,1010 # dff8 <buf>
  if(fd < 0){
    ...
    printf("%s: error: creat big failed!\n", s);
     ...
     c3e:	94e50513          	add	a0,a0,-1714 # 6588 <malloc+0x554>
    ...
    exit(1);
     ...
     c5c:	95050513          	add	a0,a0,-1712 # 65a8 <malloc+0x574>
    ...
    printf("%s: error: open big failed!\n", s);
     ...
     c78:	95c50513          	add	a0,a0,-1700 # 65d0 <malloc+0x59c>
  ...
  if(unlink("big") < 0){
     ...
     ca4:	8e050513          	add	a0,a0,-1824 # 6580 <malloc+0x54c>
     ...
     cd0:	92450513          	add	a0,a0,-1756 # 65f0 <malloc+0x5bc>
     ...
     cee:	92e50513          	add	a0,a0,-1746 # 6618 <malloc+0x5e4>
     ...
     d0c:	92850513          	add	a0,a0,-1752 # 6630 <malloc+0x5fc>
    ...
    printf("%s: unlink big failed\n", s);
     ...
     d28:	93450513          	add	a0,a0,-1740 # 6658 <malloc+0x624>
...
0000000000000d3e <unlinkread>:
{
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
     ...
     d56:	91e50513          	add	a0,a0,-1762 # 6670 <malloc+0x63c>
  ...
  write(fd, "hello", SZ);
     ...
     d6e:	93658593          	add	a1,a1,-1738 # 66a0 <malloc+0x66c>
  ...
  fd = open("unlinkread", O_RDWR);
     ...
     d8a:	8ea50513          	add	a0,a0,-1814 # 6670 <malloc+0x63c>
  ...
  if(unlink("unlinkread") != 0){
     ...
     da0:	8d450513          	add	a0,a0,-1836 # 6670 <malloc+0x63c>
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
     ...
     db6:	8be50513          	add	a0,a0,-1858 # 6670 <malloc+0x63c>
  ...
  write(fd1, "yyy", 3);
     ...
     dca:	92258593          	add	a1,a1,-1758 # 66e8 <malloc+0x6b4>
  ...
  if(read(fd, buf, sizeof(buf)) != SZ){
     ...
     de6:	21658593          	add	a1,a1,534 # dff8 <buf>
     dea:	8526                	mv	a0,s1
  ...
  if(write(fd, buf, 10) != 10){
     ...
     e10:	1ec58593          	add	a1,a1,492 # dff8 <buf>
     e14:	8526                	mv	a0,s1
  ...
  unlink("unlinkread");
     ...
     e32:	84250513          	add	a0,a0,-1982 # 6670 <malloc+0x63c>
    ...
    printf("%s: create unlinkread failed\n", s);
     ...
     e52:	83250513          	add	a0,a0,-1998 # 6680 <malloc+0x64c>
    ...
    printf("%s: open unlinkread failed\n", s);
     ...
     e6e:	83e50513          	add	a0,a0,-1986 # 66a8 <malloc+0x674>
    ...
    printf("%s: unlink unlinkread failed\n", s);
     ...
     e8a:	84250513          	add	a0,a0,-1982 # 66c8 <malloc+0x694>
    ...
    printf("%s: unlinkread read failed", s);
     ...
     ea6:	84e50513          	add	a0,a0,-1970 # 66f0 <malloc+0x6bc>
    ...
    printf("%s: unlinkread wrong data\n", s);
     ...
     ec2:	85250513          	add	a0,a0,-1966 # 6710 <malloc+0x6dc>
    ...
    printf("%s: unlinkread write failed\n", s);
     ...
     ede:	85650513          	add	a0,a0,-1962 # 6730 <malloc+0x6fc>
...
0000000000000ef4 <linktest>:
{
  ...
  if(write(fd, "hello", SZ) != SZ){
     ...
     f42:	76258593          	add	a1,a1,1890 # 66a0 <malloc+0x66c>
  ...
  if(link("lf1", "lf2") < 0){
     ...
     f62:	7fa58593          	add	a1,a1,2042 # 6758 <malloc+0x724>
     f66:	00005517          	auipc	a0,0x5
     f6a:	7ea50513          	add	a0,a0,2026 # 6750 <malloc+0x71c>
  ...
  unlink("lf1");
     ...
     f7e:	7d650513          	add	a0,a0,2006 # 6750 <malloc+0x71c>
     f82:	00005097          	auipc	ra,0x5
     f86:	cca080e7          	jalr	-822(ra) # 5c4c <unlink>
  if(open("lf1", 0) >= 0){
     f8a:	4581                	li	a1,0
     f8c:	00005517          	auipc	a0,0x5
     f90:	7c450513          	add	a0,a0,1988 # 6750 <malloc+0x71c>
  ...
  fd = open("lf2", 0);
     ...
     fa6:	7b650513          	add	a0,a0,1974 # 6758 <malloc+0x724>
  ...
  if(read(fd, buf, sizeof(buf)) != SZ){
     ...
     fbe:	03e58593          	add	a1,a1,62 # dff8 <buf>
  ...
  if(link("lf2", "lf2") >= 0){
     ...
     fde:	77e58593          	add	a1,a1,1918 # 6758 <malloc+0x724>
     fe2:	852e                	mv	a0,a1
  ...
  unlink("lf2");
     ...
     ff4:	76850513          	add	a0,a0,1896 # 6758 <malloc+0x724>
     ff8:	00005097          	auipc	ra,0x5
     ffc:	c54080e7          	jalr	-940(ra) # 5c4c <unlink>
  if(link("lf2", "lf1") >= 0){
    1000:	00005597          	auipc	a1,0x5
    1004:	75058593          	add	a1,a1,1872 # 6750 <malloc+0x71c>
    1008:	00005517          	auipc	a0,0x5
    100c:	75050513          	add	a0,a0,1872 # 6758 <malloc+0x724>
  ...
  if(link(".", "lf1") >= 0){
    ...
    1020:	73458593          	add	a1,a1,1844 # 6750 <malloc+0x71c>
    1024:	00006517          	auipc	a0,0x6
    1028:	83c50513          	add	a0,a0,-1988 # 6860 <malloc+0x82c>
    ...
    104a:	71a50513          	add	a0,a0,1818 # 6760 <malloc+0x72c>
    ...
    1066:	71650513          	add	a0,a0,1814 # 6778 <malloc+0x744>
    ...
    1082:	71250513          	add	a0,a0,1810 # 6790 <malloc+0x75c>
    ...
    109e:	71650513          	add	a0,a0,1814 # 67b0 <malloc+0x77c>
    ...
    10ba:	72a50513          	add	a0,a0,1834 # 67e0 <malloc+0x7ac>
    ...
    10d6:	72650513          	add	a0,a0,1830 # 67f8 <malloc+0x7c4>
    ...
    10f2:	72250513          	add	a0,a0,1826 # 6810 <malloc+0x7dc>
    ...
    110e:	72e50513          	add	a0,a0,1838 # 6838 <malloc+0x804>
    ...
    112a:	74250513          	add	a0,a0,1858 # 6868 <malloc+0x834>
...
0000000000001140 <validatetest>:
{
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    115c:	73098993          	add	s3,s3,1840 # 6888 <malloc+0x854>
    1160:	597d                	li	s2,-1
  for(p = 0; p <= (uint)hi; p += PGSIZE){
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    1198:	70450513          	add	a0,a0,1796 # 6898 <malloc+0x864>
...
00000000000011ae <bigdir>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    11fe:	6bea0a13          	add	s4,s4,1726 # 68b8 <malloc+0x884>
  for(i = 0; i < N; i++){
  ...
  unlink("bd");
    ...
    1250:	66c50513          	add	a0,a0,1644 # 68b8 <malloc+0x884>
  ...
  for(i = 0; i < N; i++){
    ...
    12c0:	60450513          	add	a0,a0,1540 # 68c0 <malloc+0x88c>
    ...
    12e0:	60450513          	add	a0,a0,1540 # 68e0 <malloc+0x8ac>
    ...
    12fc:	60850513          	add	a0,a0,1544 # 6900 <malloc+0x8cc>
...
000000000000134a <badarg>:
{
    ...
    135a:	35048493          	add	s1,s1,848 # c350 <uninit+0xa68>
    argv[0] = (char*)0xffffffff;
    135e:	597d                	li	s2,-1
    1360:	02095913          	srl	s2,s2,0x20
    exec("echo", argv);
    1364:	00005997          	auipc	s3,0x5
    1368:	e1498993          	add	s3,s3,-492 # 6178 <malloc+0x144>
    argv[0] = (char*)0xffffffff;
...
0000000000001390 <copyinstr2>:
{
  ...
  char *args[] = { "xx", 0 };
    ...
    13f2:	76a78793          	add	a5,a5,1898 # 7b58 <malloc+0x1b24>
  ...
  if(pid == 0){
    ...
    1428:	4bc78793          	add	a5,a5,1212 # a8e0 <big.0>
    142c:	0000a697          	auipc	a3,0xa
    1430:	4b468693          	add	a3,a3,1204 # b8e0 <big.0+0x1000>
      big[i] = 'x';
    ...
    144e:	14e78793          	add	a5,a5,334 # 8598 <malloc+0x2564>
    ...
    1472:	d0a50513          	add	a0,a0,-758 # 6178 <malloc+0x144>
    ...
    148a:	52250513          	add	a0,a0,1314 # 69a8 <malloc+0x974>
    ...
    14aa:	47a50513          	add	a0,a0,1146 # 6920 <malloc+0x8ec>
    ...
    14ca:	47a50513          	add	a0,a0,1146 # 6940 <malloc+0x90c>
    ...
    14ec:	47850513          	add	a0,a0,1144 # 6960 <malloc+0x92c>
    ...
    150c:	48050513          	add	a0,a0,1152 # 6988 <malloc+0x954>
    ...
    1526:	8e650513          	add	a0,a0,-1818 # 6e08 <malloc+0xdd4>
  ...
  if(st != 747){
    ...
    1570:	46450513          	add	a0,a0,1124 # 69d0 <malloc+0x99c>
...
0000000000001586 <truncate3>:
{
  ...
  close(open("truncfile", O_CREATE|O_TRUNC|O_WRONLY));
    ...
    159a:	c3a50513          	add	a0,a0,-966 # 61d0 <malloc+0x19c>
  ...
  if(pid == 0){
    ...
    15cc:	c08a0a13          	add	s4,s4,-1016 # 61d0 <malloc+0x19c>
      int n = write(fd, "1234567890", 10);
    15d0:	00005a97          	auipc	s5,0x5
    15d4:	460a8a93          	add	s5,s5,1120 # 6a30 <malloc+0x9fc>
      int fd = open("truncfile", O_WRONLY);
    15d8:	4585                	li	a1,1
    15da:	8552                	mv	a0,s4
    ...
    164c:	3b850513          	add	a0,a0,952 # 6a00 <malloc+0x9cc>
    ...
    1668:	3b450513          	add	a0,a0,948 # 6a18 <malloc+0x9e4>
    ...
    1686:	3be50513          	add	a0,a0,958 # 6a40 <malloc+0xa0c>
    ...
    16ac:	b28a0a13          	add	s4,s4,-1240 # 61d0 <malloc+0x19c>
    int n = write(fd, "xxx", 3);
    16b0:	00005a97          	auipc	s5,0x5
    16b4:	3b0a8a93          	add	s5,s5,944 # 6a60 <malloc+0xa2c>
    int fd = open("truncfile", O_CREATE|O_WRONLY|O_TRUNC);
  ...
  unlink("truncfile");
    ...
    16fe:	ad650513          	add	a0,a0,-1322 # 61d0 <malloc+0x19c>
  ...
  exit(xstatus);
    ...
    171c:	30050513          	add	a0,a0,768 # 6a18 <malloc+0x9e4>
    ...
    173a:	33250513          	add	a0,a0,818 # 6a68 <malloc+0xa34>
...
0000000000001750 <exectest>:
{
  ...
  char *echoargv[] = { "echo", "OK", 0 };
    ...
    1760:	a1c78793          	add	a5,a5,-1508 # 6178 <malloc+0x144>
    1764:	fcf43023          	sd	a5,-64(s0)
    1768:	00005797          	auipc	a5,0x5
    176c:	32078793          	add	a5,a5,800 # 6a88 <malloc+0xa54>
    1770:	fcf43423          	sd	a5,-56(s0)
    1774:	fc043823          	sd	zero,-48(s0)
  unlink("echo-ok");
    1778:	00005517          	auipc	a0,0x5
    177c:	31850513          	add	a0,a0,792 # 6a90 <malloc+0xa5c>
  ...
  if(pid == 0) {
    ...
    17ac:	2e850513          	add	a0,a0,744 # 6a90 <malloc+0xa5c>
    ...
    17c8:	2ec50513          	add	a0,a0,748 # 6ab0 <malloc+0xa7c>
    ...
    17e6:	21e50513          	add	a0,a0,542 # 6a00 <malloc+0x9cc>
    ...
    1802:	29a50513          	add	a0,a0,666 # 6a98 <malloc+0xa64>
    ...
    1820:	95c50513          	add	a0,a0,-1700 # 6178 <malloc+0x144>
  ...
  if(xstatus != 0)
    ...
    1854:	27050513          	add	a0,a0,624 # 6ac0 <malloc+0xa8c>
    ...
    1870:	26c50513          	add	a0,a0,620 # 6ad8 <malloc+0xaa4>
  ...
  fd = open("echo-ok", O_RDONLY);
    ...
    1884:	21050513          	add	a0,a0,528 # 6a90 <malloc+0xa5c>
  ...
  if (read(fd, buf, 2) != 2) {
    ...
    18ae:	c9e50513          	add	a0,a0,-866 # 6548 <malloc+0x514>
    ...
    18ca:	15250513          	add	a0,a0,338 # 6a18 <malloc+0x9e4>
  ...
  unlink("echo-ok");
    ...
    18e4:	1b050513          	add	a0,a0,432 # 6a90 <malloc+0xa5c>
  ...
  if(buf[0] == 'O' && buf[1] == 'K')
    ...
    190e:	1e650513          	add	a0,a0,486 # 6af0 <malloc+0xabc>
...
000000000000192e <pipe1>:
{
  ...
  if(pid == 0){
    ...
    1976:	686a8a93          	add	s5,s5,1670 # dff8 <buf>
    197a:	864a                	mv	a2,s2
    197c:	85d6                	mv	a1,s5
    ...
    1992:	66a70713          	add	a4,a4,1642 # dff8 <buf>
    ...
    19d6:	13650513          	add	a0,a0,310 # 6b08 <malloc+0xad4>
    ...
    1a04:	5f8b0b13          	add	s6,s6,1528 # dff8 <buf>
    ...
    1a18:	42da8a93          	add	s5,s5,1069 # 142d <copyinstr2+0x9d>
{
    ...
    1a64:	0c050513          	add	a0,a0,192 # 6b20 <malloc+0xaec>
    ...
    1a80:	0bc50513          	add	a0,a0,188 # 6b38 <malloc+0xb04>
    ...
    1ab2:	0a250513          	add	a0,a0,162 # 6b50 <malloc+0xb1c>
    ...
    1afe:	07650513          	add	a0,a0,118 # 6b70 <malloc+0xb3c>
...
0000000000001b14 <exitwait>:
{
  ...
  for(i = 0; i < 100; i++){
    ...
    1b70:	e9450513          	add	a0,a0,-364 # 6a00 <malloc+0x9cc>
    ...
    1ba8:	ffc50513          	add	a0,a0,-4 # 6ba0 <malloc+0xb6c>
...
0000000000001bc8 <twochildren>:
{
  ...
  for(int i = 0; i < 1000; i++){
    ...
    1c20:	de450513          	add	a0,a0,-540 # 6a00 <malloc+0x9cc>
    ...
    1c44:	dc050513          	add	a0,a0,-576 # 6a00 <malloc+0x9cc>
...
0000000000001c62 <forkfork>:
{
    ...
    1cbe:	f0650513          	add	a0,a0,-250 # 6bc0 <malloc+0xb8c>
    ...
    1cd0:	f30080e7          	jalr	-208(ra) # 5bfc <exit>
{
    ...
    1d16:	ebe50513          	add	a0,a0,-322 # 6bd0 <malloc+0xb9c>
...
0000000000001d2c <reparent2>:
{
  ...
  exit(0);
    ...
    1d64:	0a850513          	add	a0,a0,168 # 6e08 <malloc+0xdd4>
...
0000000000001d94 <createdelete>:
{
  ...
  name[0] = name[1] = name[2] = 0;
    ...
    1e02:	00a50513          	add	a0,a0,10 # 6e08 <malloc+0xdd4>
    ...
    1e2e:	c6e50513          	add	a0,a0,-914 # 6a98 <malloc+0xa64>
    ...
    1ea0:	d5450513          	add	a0,a0,-684 # 6bf0 <malloc+0xbbc>
    ...
    1ed4:	d3850513          	add	a0,a0,-712 # 6c08 <malloc+0xbd4>
    ...
    1f36:	cfe50513          	add	a0,a0,-770 # 6c30 <malloc+0xbfc>
...
0000000000001fba <linkunlink>:
{
  ...
  unlink("x");
    ...
    1fda:	21250513          	add	a0,a0,530 # 61e8 <malloc+0x1b4>
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    2004:	e6da0a1b          	addw	s4,s4,-403 # 41c64e6d <base+0x41c53e75>
    ...
    2016:	1d6b0b13          	add	s6,s6,470 # 61e8 <malloc+0x1b4>
      link("cat", "x");
    201a:	00005c17          	auipc	s8,0x5
    201e:	c3ec0c13          	add	s8,s8,-962 # 6c58 <malloc+0xc24>
    2022:	a825                	j	205a <linkunlink+0xa0>
    printf("%s: fork failed\n", s);
    2024:	85a6                	mv	a1,s1
    2026:	00005517          	auipc	a0,0x5
    202a:	9da50513          	add	a0,a0,-1574 # 6a00 <malloc+0x9cc>
...
00000000000020be <forktest>:
{
  ...
  for(n=0; n<N; n++){
    ...
    20ee:	bbe50513          	add	a0,a0,-1090 # 6ca8 <malloc+0xc74>
    ...
    2112:	b5250513          	add	a0,a0,-1198 # 6c60 <malloc+0xc2c>
    ...
    212e:	b4e50513          	add	a0,a0,-1202 # 6c78 <malloc+0xc44>
    ...
    214a:	b4a50513          	add	a0,a0,-1206 # 6c90 <malloc+0xc5c>
...
0000000000002196 <kernmem>:
{
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    21b2:	35098993          	add	s3,s3,848 # c350 <uninit+0xa68>
    21b6:	1003d937          	lui	s2,0x1003d
    21ba:	090e                	sll	s2,s2,0x3
    21bc:	48090913          	add	s2,s2,1152 # 1003d480 <base+0x1002c488>
    pid = fork();
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    2200:	80450513          	add	a0,a0,-2044 # 6a00 <malloc+0x9cc>
    ...
    2222:	ab250513          	add	a0,a0,-1358 # 6cd0 <malloc+0xc9c>
...
0000000000002242 <MAXVAplus>:
{
  ...
  for( ; a != 0; a <<= 1){
    ...
    22a4:	76050513          	add	a0,a0,1888 # 6a00 <malloc+0x9cc>
    ...
    22d0:	a2450513          	add	a0,a0,-1500 # 6cf0 <malloc+0xcbc>
...
00000000000022f0 <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    ...
    2300:	a0c50513          	add	a0,a0,-1524 # 6d08 <malloc+0xcd4>
  ...
  fd = open("bigarg-ok", 0);
    ...
    2332:	9da50513          	add	a0,a0,-1574 # 6d08 <malloc+0xcd4>
  ...
  close(fd);
    ...
    2358:	48c78793          	add	a5,a5,1164 # a7e0 <args.1>
    235c:	00008697          	auipc	a3,0x8
    2360:	57c68693          	add	a3,a3,1404 # a8d8 <args.1+0xf8>
      args[i] = "bigargs test: failed\n                                                                                                                                                                                                       ";
    2364:	00005717          	auipc	a4,0x5
    2368:	9b470713          	add	a4,a4,-1612 # 6d18 <malloc+0xce4>
    ...
    23bc:	a4050513          	add	a0,a0,-1472 # 6df8 <malloc+0xdc4>
    ...
    23e0:	a3c50513          	add	a0,a0,-1476 # 6e18 <malloc+0xde4>
...
r_sp()
{
  ...
  asm volatile("mv %0, sp" : "=r" (x) );
    ...
    243e:	9fe50513          	add	a0,a0,-1538 # 6e38 <malloc+0xe04>
    ...
    245a:	5aa50513          	add	a0,a0,1450 # 6a00 <malloc+0x9cc>
...
000000000000247a <textwrite>:
{
  ...
  if(xstatus == -1)  // kernel killed child?
    ...
    *addr = 10;
    ...
    24c8:	53c50513          	add	a0,a0,1340 # 6a00 <malloc+0x9cc>
...
00000000000024e8 <manywrites>:
{
  ...
  exit(0);
    ...
    254c:	8c050513          	add	a0,a0,-1856 # 6e08 <malloc+0xdd4>
    ...
    258e:	a6eb0b13          	add	s6,s6,-1426 # dff8 <buf>
    ...
    2602:	86250513          	add	a0,a0,-1950 # 6e60 <malloc+0xe2c>
    ...
    2622:	c2a50513          	add	a0,a0,-982 # 6248 <malloc+0x214>
...
0000000000002640 <copyinstr3>:
{
  ...
  *b = 'x';
  ...
  char *args[] = { "xx", 0 };
    ...
    26ba:	4a278793          	add	a5,a5,1186 # 7b58 <malloc+0x1b24>
  ...
  if(ret != -1){
    ...
    26fc:	78050513          	add	a0,a0,1920 # 6e78 <malloc+0xe44>
    ...
    271a:	20a50513          	add	a0,a0,522 # 6920 <malloc+0x8ec>
    ...
    2738:	20c50513          	add	a0,a0,524 # 6940 <malloc+0x90c>
    ...
    2758:	20c50513          	add	a0,a0,524 # 6960 <malloc+0x92c>
    ...
    2776:	21650513          	add	a0,a0,534 # 6988 <malloc+0x954>
...
000000000000278c <rwsbrk>:
{
  ...
  fd = open("rwsbrk", O_CREATE|O_WRONLY);
    ...
    27c2:	6fa50513          	add	a0,a0,1786 # 6eb8 <malloc+0xe84>
  ...
  if(n >= 0){
    ...
    27f2:	6ea50513          	add	a0,a0,1770 # 6ed8 <malloc+0xea4>
    ...
    2810:	67450513          	add	a0,a0,1652 # 6e80 <malloc+0xe4c>
    ...
    282c:	67050513          	add	a0,a0,1648 # 6e98 <malloc+0xe64>
    ...
    2846:	67e50513          	add	a0,a0,1662 # 6ec0 <malloc+0xe8c>
  ...
  if(n >= 0){
    ...
    28a6:	66650513          	add	a0,a0,1638 # 6f08 <malloc+0xed4>
    ...
    28c0:	60450513          	add	a0,a0,1540 # 6ec0 <malloc+0xe8c>
...
00000000000028ea <sbrkbasic>:
{
  ...
  if(pid == 0){
    ...
    2946:	5ee50513          	add	a0,a0,1518 # 6f30 <malloc+0xefc>
  ...
  for(i = 0; i < 5000; i++){
    ...
    29aa:	5aa50513          	add	a0,a0,1450 # 6f50 <malloc+0xf1c>
  ...
  if(c != a + 1){
    ...
    2a0e:	5a650513          	add	a0,a0,1446 # 6fb0 <malloc+0xf7c>
    ...
    2a30:	54450513          	add	a0,a0,1348 # 6f70 <malloc+0xf3c>
    ...
    2a4c:	54850513          	add	a0,a0,1352 # 6f90 <malloc+0xf5c>
...
0000000000002a88 <sbrkmuch>:
{
  ...
  *lastaddr = 99;
  ...
  if(c != a){
    ...
    2b96:	43e50513          	add	a0,a0,1086 # 6fd0 <malloc+0xf9c>
    ...
    2bb2:	46a50513          	add	a0,a0,1130 # 7018 <malloc+0xfe4>
    ...
    2bd2:	46a50513          	add	a0,a0,1130 # 7038 <malloc+0x1004>
    ...
    2bf2:	48a50513          	add	a0,a0,1162 # 7078 <malloc+0x1044>
    ...
    2c0e:	49e50513          	add	a0,a0,1182 # 70a8 <malloc+0x1074>
    ...
    2c2e:	4b650513          	add	a0,a0,1206 # 70e0 <malloc+0x10ac>
...
0000000000002c44 <sbrkarg>:
{
  ...
  fd = open("sbrk", O_CREATE|O_WRONLY);
    ...
    2c68:	4a450513          	add	a0,a0,1188 # 7108 <malloc+0x10d4>
    2c6c:	00003097          	auipc	ra,0x3
    2c70:	fd0080e7          	jalr	-48(ra) # 5c3c <open>
    2c74:	84aa                	mv	s1,a0
  unlink("sbrk");
    2c76:	00004517          	auipc	a0,0x4
    2c7a:	49250513          	add	a0,a0,1170 # 7108 <malloc+0x10d4>
  ...
  if(pipe((int *) a) != 0){
    ...
    2cce:	44650513          	add	a0,a0,1094 # 7110 <malloc+0x10dc>
    ...
    2cea:	44250513          	add	a0,a0,1090 # 7128 <malloc+0x10f4>
    ...
    2d06:	e0650513          	add	a0,a0,-506 # 6b08 <malloc+0xad4>
...
0000000000002d1c <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    ...
    2d30:	41450513          	add	a0,a0,1044 # 7140 <malloc+0x110c>
  ...
  close(fd);
    ...
    2d78:	ca450513          	add	a0,a0,-860 # 6a18 <malloc+0x9e4>
...
0000000000002d8e <sbrkbugs>:
{
  ...
  if(pid == 0){
    ...
    2dc6:	04650513          	add	a0,a0,70 # 6e08 <malloc+0xdd4>
  ...
  if(pid == 0){
    ...
    2e1c:	ff050513          	add	a0,a0,-16 # 6e08 <malloc+0xdd4>
  ...
  if(pid == 0){
    ...
    2e54:	8007879b          	addw	a5,a5,-2048 # a800 <args.1+0x20>
    ...
    2e7c:	f9050513          	add	a0,a0,-112 # 6e08 <malloc+0xdd4>
...
0000000000002f78 <sbrk8000>:
{
  ...
  sbrk(0x80000004);
    ...
    2f84:	0511                	add	a0,a0,4 # ffffffff80000004 <base+0xffffffff7ffef00c>
...
0000000000002fae <execout>:
{
  ...
  exit(0);
    ...
    2ff0:	e1c50513          	add	a0,a0,-484 # 6e08 <malloc+0xdd4>
    ...
    3044:	13850513          	add	a0,a0,312 # 6178 <malloc+0x144>
    3048:	faa43c23          	sd	a0,-72(s0)
    304c:	00003797          	auipc	a5,0x3
    3050:	19c78793          	add	a5,a5,412 # 61e8 <malloc+0x1b4>
...
0000000000003072 <fourteen>:
{
  ...
  if(mkdir("12345678901234") != 0){
    ...
    3082:	29a50513          	add	a0,a0,666 # 7318 <malloc+0x12e4>
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    3094:	0e050513          	add	a0,a0,224 # 7170 <malloc+0x113c>
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    30aa:	12250513          	add	a0,a0,290 # 71c8 <malloc+0x1194>
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    30c8:	17c50513          	add	a0,a0,380 # 7240 <malloc+0x120c>
  ...
  if(mkdir("12345678901234/12345678901234") == 0){
    ...
    30e4:	1d050513          	add	a0,a0,464 # 72b0 <malloc+0x127c>
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    ...
    30f6:	21650513          	add	a0,a0,534 # 7308 <malloc+0x12d4>
  ...
  unlink("12345678901234");
    ...
    3174:	fd850513          	add	a0,a0,-40 # 7148 <malloc+0x1114>
    ...
    3190:	00450513          	add	a0,a0,4 # 7190 <malloc+0x115c>
    ...
    31ac:	05050513          	add	a0,a0,80 # 71f8 <malloc+0x11c4>
    ...
    31c8:	0ac50513          	add	a0,a0,172 # 7270 <malloc+0x123c>
    ...
    31e4:	0f050513          	add	a0,a0,240 # 72d0 <malloc+0x129c>
    ...
    3200:	12c50513          	add	a0,a0,300 # 7328 <malloc+0x12f4>
...
0000000000003216 <diskfull>:
{
  ...
  unlink("diskfulldir");
    ...
    324c:	11850513          	add	a0,a0,280 # 7360 <malloc+0x132c>
  ...
  for(fi = 0; done == 0; fi++){
    ...
    3276:	0fe50513          	add	a0,a0,254 # 7370 <malloc+0x133c>
  ...
  if(mkdir("diskfulldir") == 0)
    ...
    3306:	05e50513          	add	a0,a0,94 # 7360 <malloc+0x132c>
  ...
  unlink("diskfulldir");
    ...
    331a:	04a50513          	add	a0,a0,74 # 7360 <malloc+0x132c>
  ...
  for(fi = 0; done == 0; fi++){
    ...
    3448:	f4c50513          	add	a0,a0,-180 # 7390 <malloc+0x135c>
...
0000000000003456 <iputtest>:
{
  ...
  if(mkdir("iputdir") < 0){
    ...
    3466:	f5e50513          	add	a0,a0,-162 # 73c0 <malloc+0x138c>
  ...
  if(chdir("iputdir") < 0){
    ...
    347a:	f4a50513          	add	a0,a0,-182 # 73c0 <malloc+0x138c>
  ...
  if(unlink("../iputdir") < 0){
    ...
    348e:	f7650513          	add	a0,a0,-138 # 7400 <malloc+0x13cc>
  ...
  if(chdir("/") < 0){
    ...
    34a2:	f9250513          	add	a0,a0,-110 # 7430 <malloc+0x13fc>
    ...
    34c2:	f0a50513          	add	a0,a0,-246 # 73c8 <malloc+0x1394>
    ...
    34de:	f0650513          	add	a0,a0,-250 # 73e0 <malloc+0x13ac>
    ...
    34fa:	f1a50513          	add	a0,a0,-230 # 7410 <malloc+0x13dc>
    ...
    3516:	f2650513          	add	a0,a0,-218 # 7438 <malloc+0x1404>
...
000000000000352c <exitiputtest>:
{
  ...
  if(pid == 0){
    ...
    354a:	e7a50513          	add	a0,a0,-390 # 73c0 <malloc+0x138c>
    ...
    355e:	e6650513          	add	a0,a0,-410 # 73c0 <malloc+0x138c>
    ...
    3572:	e9250513          	add	a0,a0,-366 # 7400 <malloc+0x13cc>
    ...
    3592:	47250513          	add	a0,a0,1138 # 6a00 <malloc+0x9cc>
    ...
    35ae:	e1e50513          	add	a0,a0,-482 # 73c8 <malloc+0x1394>
    ...
    35ca:	e8a50513          	add	a0,a0,-374 # 7450 <malloc+0x141c>
    ...
    35e6:	e2e50513          	add	a0,a0,-466 # 7410 <malloc+0x13dc>
...
0000000000003614 <dirtest>:
{
  ...
  if(mkdir("dir0") < 0){
    ...
    3624:	e4850513          	add	a0,a0,-440 # 7468 <malloc+0x1434>
  ...
  if(chdir("dir0") < 0){
    ...
    3638:	e3450513          	add	a0,a0,-460 # 7468 <malloc+0x1434>
  ...
  if(chdir("..") < 0){
    ...
    364c:	e4050513          	add	a0,a0,-448 # 7488 <malloc+0x1454>
  ...
  if(unlink("dir0") < 0){
    ...
    3660:	e0c50513          	add	a0,a0,-500 # 7468 <malloc+0x1434>
    ...
    3680:	d4c50513          	add	a0,a0,-692 # 73c8 <malloc+0x1394>
    ...
    369c:	dd850513          	add	a0,a0,-552 # 7470 <malloc+0x143c>
    ...
    36b8:	ddc50513          	add	a0,a0,-548 # 7490 <malloc+0x145c>
    ...
    36d4:	dd850513          	add	a0,a0,-552 # 74a8 <malloc+0x1474>
...
00000000000036ea <subdir>:
{
  ...
  unlink("ff");
    ...
    36fc:	ef850513          	add	a0,a0,-264 # 75f0 <malloc+0x15bc>
    3700:	00002097          	auipc	ra,0x2
    3704:	54c080e7          	jalr	1356(ra) # 5c4c <unlink>
  if(mkdir("dd") != 0){
    3708:	00004517          	auipc	a0,0x4
    370c:	db850513          	add	a0,a0,-584 # 74c0 <malloc+0x148c>
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    3724:	dc050513          	add	a0,a0,-576 # 74e0 <malloc+0x14ac>
  ...
  write(fd, "ff", 2);
    ...
    373c:	eb858593          	add	a1,a1,-328 # 75f0 <malloc+0x15bc>
  ...
  if(unlink("dd") >= 0){
    ...
    3756:	d6e50513          	add	a0,a0,-658 # 74c0 <malloc+0x148c>
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    376a:	dd250513          	add	a0,a0,-558 # 7538 <malloc+0x1504>
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    3782:	de250513          	add	a0,a0,-542 # 7560 <malloc+0x152c>
  ...
  write(fd, "FF", 2);
    ...
    379a:	dfa58593          	add	a1,a1,-518 # 7590 <malloc+0x155c>
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    37b6:	de650513          	add	a0,a0,-538 # 7598 <malloc+0x1564>
  ...
  cc = read(fd, buf, sizeof(buf));
    ...
    37ce:	82e58593          	add	a1,a1,-2002 # dff8 <buf>
  ...
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    ...
    37fe:	dee58593          	add	a1,a1,-530 # 75e8 <malloc+0x15b4>
    3802:	00004517          	auipc	a0,0x4
    3806:	d5e50513          	add	a0,a0,-674 # 7560 <malloc+0x152c>
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    381a:	d4a50513          	add	a0,a0,-694 # 7560 <malloc+0x152c>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    3830:	d3450513          	add	a0,a0,-716 # 7560 <malloc+0x152c>
  ...
  if(chdir("dd") != 0){
    ...
    3844:	c8050513          	add	a0,a0,-896 # 74c0 <malloc+0x148c>
  ...
  if(chdir("dd/../../dd") != 0){
    ...
    3858:	e2c50513          	add	a0,a0,-468 # 7680 <malloc+0x164c>
  ...
  if(chdir("dd/../../../dd") != 0){
    ...
    386c:	e4850513          	add	a0,a0,-440 # 76b0 <malloc+0x167c>
  ...
  if(chdir("./..") != 0){
    ...
    3880:	e6450513          	add	a0,a0,-412 # 76e0 <malloc+0x16ac>
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    3896:	d5650513          	add	a0,a0,-682 # 75e8 <malloc+0x15b4>
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    38ae:	74e58593          	add	a1,a1,1870 # dff8 <buf>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    38d0:	c9450513          	add	a0,a0,-876 # 7560 <malloc+0x152c>
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    38e8:	e8c50513          	add	a0,a0,-372 # 7770 <malloc+0x173c>
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    3900:	ea450513          	add	a0,a0,-348 # 77a0 <malloc+0x176c>
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    3918:	bac50513          	add	a0,a0,-1108 # 74c0 <malloc+0x148c>
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    392e:	b9650513          	add	a0,a0,-1130 # 74c0 <malloc+0x148c>
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    3944:	b8050513          	add	a0,a0,-1152 # 74c0 <malloc+0x148c>
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    3958:	edc58593          	add	a1,a1,-292 # 7830 <malloc+0x17fc>
    395c:	00004517          	auipc	a0,0x4
    3960:	e1450513          	add	a0,a0,-492 # 7770 <malloc+0x173c>
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    3974:	ec058593          	add	a1,a1,-320 # 7830 <malloc+0x17fc>
    3978:	00004517          	auipc	a0,0x4
    397c:	e2850513          	add	a0,a0,-472 # 77a0 <malloc+0x176c>
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    3990:	c5c58593          	add	a1,a1,-932 # 75e8 <malloc+0x15b4>
    3994:	00004517          	auipc	a0,0x4
    3998:	b4c50513          	add	a0,a0,-1204 # 74e0 <malloc+0x14ac>
  ...
  if(mkdir("dd/ff/ff") == 0){
    ...
    39ac:	dc850513          	add	a0,a0,-568 # 7770 <malloc+0x173c>
  ...
  if(mkdir("dd/xx/ff") == 0){
    ...
    39c0:	de450513          	add	a0,a0,-540 # 77a0 <malloc+0x176c>
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    39d4:	c1850513          	add	a0,a0,-1000 # 75e8 <malloc+0x15b4>
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    39e8:	dbc50513          	add	a0,a0,-580 # 77a0 <malloc+0x176c>
  ...
  if(unlink("dd/ff/ff") == 0){
    ...
    39fc:	d7850513          	add	a0,a0,-648 # 7770 <malloc+0x173c>
  ...
  if(chdir("dd/ff") == 0){
    ...
    3a10:	ad450513          	add	a0,a0,-1324 # 74e0 <malloc+0x14ac>
  ...
  if(chdir("dd/xx") == 0){
    ...
    3a24:	f6050513          	add	a0,a0,-160 # 7980 <malloc+0x194c>
  ...
  if(unlink("dd/dd/ffff") != 0){
    ...
    3a38:	bb450513          	add	a0,a0,-1100 # 75e8 <malloc+0x15b4>
  ...
  if(unlink("dd/ff") != 0){
    ...
    3a4c:	a9850513          	add	a0,a0,-1384 # 74e0 <malloc+0x14ac>
  ...
  if(unlink("dd") == 0){
    ...
    3a60:	a6450513          	add	a0,a0,-1436 # 74c0 <malloc+0x148c>
  ...
  if(unlink("dd/dd") < 0){
    ...
    3a74:	f8050513          	add	a0,a0,-128 # 79f0 <malloc+0x19bc>
  ...
  if(unlink("dd") < 0){
    ...
    3a88:	a3c50513          	add	a0,a0,-1476 # 74c0 <malloc+0x148c>
    ...
    3aaa:	a2250513          	add	a0,a0,-1502 # 74c8 <malloc+0x1494>
    ...
    3ac6:	a2650513          	add	a0,a0,-1498 # 74e8 <malloc+0x14b4>
    ...
    3ae2:	a2a50513          	add	a0,a0,-1494 # 7508 <malloc+0x14d4>
    ...
    3afe:	a4650513          	add	a0,a0,-1466 # 7540 <malloc+0x150c>
    ...
    3b1a:	a5a50513          	add	a0,a0,-1446 # 7570 <malloc+0x153c>
    ...
    3b36:	a7650513          	add	a0,a0,-1418 # 75a8 <malloc+0x1574>
    ...
    3b52:	a7a50513          	add	a0,a0,-1414 # 75c8 <malloc+0x1594>
    ...
    3b6e:	a8e50513          	add	a0,a0,-1394 # 75f8 <malloc+0x15c4>
    ...
    3b8a:	a9a50513          	add	a0,a0,-1382 # 7620 <malloc+0x15ec>
    ...
    3ba6:	a9e50513          	add	a0,a0,-1378 # 7640 <malloc+0x160c>
    ...
    3bc2:	aaa50513          	add	a0,a0,-1366 # 7668 <malloc+0x1634>
    ...
    3bde:	ab650513          	add	a0,a0,-1354 # 7690 <malloc+0x165c>
    ...
    3bfa:	aca50513          	add	a0,a0,-1334 # 76c0 <malloc+0x168c>
    ...
    3c16:	ad650513          	add	a0,a0,-1322 # 76e8 <malloc+0x16b4>
    ...
    3c32:	ad250513          	add	a0,a0,-1326 # 7700 <malloc+0x16cc>
    ...
    3c4e:	ad650513          	add	a0,a0,-1322 # 7720 <malloc+0x16ec>
    ...
    3c6a:	ada50513          	add	a0,a0,-1318 # 7740 <malloc+0x170c>
    ...
    3c86:	afe50513          	add	a0,a0,-1282 # 7780 <malloc+0x174c>
    ...
    3ca2:	b1250513          	add	a0,a0,-1262 # 77b0 <malloc+0x177c>
    ...
    3cbe:	b1650513          	add	a0,a0,-1258 # 77d0 <malloc+0x179c>
    ...
    3cda:	b1a50513          	add	a0,a0,-1254 # 77f0 <malloc+0x17bc>
    ...
    3cf6:	b1e50513          	add	a0,a0,-1250 # 7810 <malloc+0x17dc>
    ...
    3d12:	b3250513          	add	a0,a0,-1230 # 7840 <malloc+0x180c>
    ...
    3d2e:	b3e50513          	add	a0,a0,-1218 # 7868 <malloc+0x1834>
    ...
    3d4a:	b4a50513          	add	a0,a0,-1206 # 7890 <malloc+0x185c>
    ...
    3d66:	b5650513          	add	a0,a0,-1194 # 78b8 <malloc+0x1884>
    ...
    3d82:	b5a50513          	add	a0,a0,-1190 # 78d8 <malloc+0x18a4>
    ...
    3d9e:	b5e50513          	add	a0,a0,-1186 # 78f8 <malloc+0x18c4>
    ...
    3dba:	b6a50513          	add	a0,a0,-1174 # 7920 <malloc+0x18ec>
    ...
    3dd6:	b6e50513          	add	a0,a0,-1170 # 7940 <malloc+0x190c>
    ...
    3df2:	b7250513          	add	a0,a0,-1166 # 7960 <malloc+0x192c>
    ...
    3e0e:	b7e50513          	add	a0,a0,-1154 # 7988 <malloc+0x1954>
    ...
    3e2a:	7fa50513          	add	a0,a0,2042 # 7620 <malloc+0x15ec>
    ...
    3e46:	b6650513          	add	a0,a0,-1178 # 79a8 <malloc+0x1974>
    ...
    3e62:	b6a50513          	add	a0,a0,-1174 # 79c8 <malloc+0x1994>
    ...
    3e7e:	b7e50513          	add	a0,a0,-1154 # 79f8 <malloc+0x19c4>
    ...
    3e9a:	b8250513          	add	a0,a0,-1150 # 7a18 <malloc+0x19e4>
...
0000000000003eb0 <rmdot>:
{
  ...
  if(mkdir("dots") != 0){
    ...
    3ec0:	b7450513          	add	a0,a0,-1164 # 7a30 <malloc+0x19fc>
  ...
  if(chdir("dots") != 0){
    ...
    3ed2:	b6250513          	add	a0,a0,-1182 # 7a30 <malloc+0x19fc>
  ...
  if(unlink(".") == 0){
    ...
    3ee4:	98050513          	add	a0,a0,-1664 # 6860 <malloc+0x82c>
  ...
  if(unlink("..") == 0){
    ...
    3ef6:	59650513          	add	a0,a0,1430 # 7488 <malloc+0x1454>
  ...
  if(chdir("/") != 0){
    ...
    3f08:	52c50513          	add	a0,a0,1324 # 7430 <malloc+0x13fc>
  ...
  if(unlink("dots/.") == 0){
    ...
    3f1a:	b8250513          	add	a0,a0,-1150 # 7a98 <malloc+0x1a64>
  ...
  if(unlink("dots/..") == 0){
    ...
    3f2c:	b9850513          	add	a0,a0,-1128 # 7ac0 <malloc+0x1a8c>
  ...
  if(unlink("dots") != 0){
    ...
    3f3e:	af650513          	add	a0,a0,-1290 # 7a30 <malloc+0x19fc>
    ...
    3f5c:	ae050513          	add	a0,a0,-1312 # 7a38 <malloc+0x1a04>
    ...
    3f78:	adc50513          	add	a0,a0,-1316 # 7a50 <malloc+0x1a1c>
    ...
    3f94:	ad850513          	add	a0,a0,-1320 # 7a68 <malloc+0x1a34>
    ...
    3fb0:	ad450513          	add	a0,a0,-1324 # 7a80 <malloc+0x1a4c>
    ...
    3fcc:	47050513          	add	a0,a0,1136 # 7438 <malloc+0x1404>
    ...
    3fe8:	abc50513          	add	a0,a0,-1348 # 7aa0 <malloc+0x1a6c>
    ...
    4004:	ac850513          	add	a0,a0,-1336 # 7ac8 <malloc+0x1a94>
    ...
    4020:	acc50513          	add	a0,a0,-1332 # 7ae8 <malloc+0x1ab4>
...
0000000000004036 <dirfile>:
{
  ...
  fd = open("dirfile", O_CREATE);
    ...
    404c:	ac050513          	add	a0,a0,-1344 # 7b08 <malloc+0x1ad4>
  ...
  if(chdir("dirfile") == 0){
    ...
    4068:	aa450513          	add	a0,a0,-1372 # 7b08 <malloc+0x1ad4>
  ...
  fd = open("dirfile/xx", 0);
    ...
    407c:	ad850513          	add	a0,a0,-1320 # 7b50 <malloc+0x1b1c>
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    4094:	ac050513          	add	a0,a0,-1344 # 7b50 <malloc+0x1b1c>
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    40a8:	aac50513          	add	a0,a0,-1364 # 7b50 <malloc+0x1b1c>
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    40bc:	a9850513          	add	a0,a0,-1384 # 7b50 <malloc+0x1b1c>
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    40d0:	a8458593          	add	a1,a1,-1404 # 7b50 <malloc+0x1b1c>
    40d4:	00002517          	auipc	a0,0x2
    40d8:	27c50513          	add	a0,a0,636 # 6350 <malloc+0x31c>
  ...
  if(unlink("dirfile") != 0){
    ...
    40ec:	a2050513          	add	a0,a0,-1504 # 7b08 <malloc+0x1ad4>
  ...
  fd = open(".", O_RDWR);
    ...
    4102:	76250513          	add	a0,a0,1890 # 6860 <malloc+0x82c>
  ...
  fd = open(".", 0);
    ...
    4118:	74c50513          	add	a0,a0,1868 # 6860 <malloc+0x82c>
  ...
  if(write(fd, "x", 1) > 0){
    ...
    412c:	0c058593          	add	a1,a1,192 # 61e8 <malloc+0x1b4>
  ...
  close(fd);
    ...
    4158:	9bc50513          	add	a0,a0,-1604 # 7b10 <malloc+0x1adc>
    ...
    4174:	9c050513          	add	a0,a0,-1600 # 7b30 <malloc+0x1afc>
    ...
    4190:	9d450513          	add	a0,a0,-1580 # 7b60 <malloc+0x1b2c>
    ...
    41ac:	9b850513          	add	a0,a0,-1608 # 7b60 <malloc+0x1b2c>
    ...
    41c8:	9c450513          	add	a0,a0,-1596 # 7b88 <malloc+0x1b54>
    ...
    41e4:	9d050513          	add	a0,a0,-1584 # 7bb0 <malloc+0x1b7c>
    ...
    4200:	9dc50513          	add	a0,a0,-1572 # 7bd8 <malloc+0x1ba4>
    ...
    421c:	9e850513          	add	a0,a0,-1560 # 7c00 <malloc+0x1bcc>
    ...
    4238:	9ec50513          	add	a0,a0,-1556 # 7c20 <malloc+0x1bec>
    ...
    4254:	9f850513          	add	a0,a0,-1544 # 7c48 <malloc+0x1c14>
...
000000000000426a <iref>:
{
    ...
    4288:	9dca0a13          	add	s4,s4,-1572 # 7c60 <malloc+0x1c2c>
    mkdir("");
    428c:	00003497          	auipc	s1,0x3
    4290:	4dc48493          	add	s1,s1,1244 # 7768 <malloc+0x1734>
    link("README", "");
    4294:	00002a97          	auipc	s5,0x2
    4298:	0bca8a93          	add	s5,s5,188 # 6350 <malloc+0x31c>
    fd = open("xx", O_CREATE);
    429c:	00004997          	auipc	s3,0x4
    42a0:	8bc98993          	add	s3,s3,-1860 # 7b58 <malloc+0x1b24>
    42a4:	a891                	j	42f8 <iref+0x8e>
      printf("%s: mkdir irefd failed\n", s);
    42a6:	85da                	mv	a1,s6
    42a8:	00004517          	auipc	a0,0x4
    42ac:	9c050513          	add	a0,a0,-1600 # 7c68 <malloc+0x1c34>
    ...
    42c8:	9bc50513          	add	a0,a0,-1604 # 7c80 <malloc+0x1c4c>
  ...
  for(i = 0; i < NINODE + 1; i++){
    ...
    435c:	13098993          	add	s3,s3,304 # 7488 <malloc+0x1454>
    unlink("irefd");
    4360:	00004917          	auipc	s2,0x4
    4364:	90090913          	add	s2,s2,-1792 # 7c60 <malloc+0x1c2c>
    chdir("..");
    4368:	854e                	mv	a0,s3
  ...
  chdir("/");
    ...
    4384:	0b050513          	add	a0,a0,176 # 7430 <malloc+0x13fc>
...
00000000000043a4 <openiputtest>:
{
  ...
  if(mkdir("oidir") < 0){
    ...
    43b4:	8e850513          	add	a0,a0,-1816 # 7c98 <malloc+0x1c64>
  ...
  if(pid == 0){
    ...
    43d8:	8c450513          	add	a0,a0,-1852 # 7c98 <malloc+0x1c64>
    ...
    43ee:	8ce50513          	add	a0,a0,-1842 # 7cb8 <malloc+0x1c84>
    ...
    440a:	89a50513          	add	a0,a0,-1894 # 7ca0 <malloc+0x1c6c>
    ...
    4426:	5de50513          	add	a0,a0,1502 # 6a00 <malloc+0x9cc>
  ...
  if(unlink("oidir") != 0){
    ...
    4454:	84850513          	add	a0,a0,-1976 # 7c98 <malloc+0x1c64>
    ...
    4468:	78c50513          	add	a0,a0,1932 # 6bf0 <malloc+0xbbc>
...
0000000000004496 <forkforkfork>:
{
  ...
  unlink("stopforking");
    ...
    44a6:	83e50513          	add	a0,a0,-1986 # 7ce0 <malloc+0x1cac>
  ...
  close(open("stopforking", O_CREATE|O_RDWR));
    ...
    44d2:	81250513          	add	a0,a0,-2030 # 7ce0 <malloc+0x1cac>
  ...
  sleep(10); // one second
    ...
    450a:	6ba50513          	add	a0,a0,1722 # 6bc0 <malloc+0xb8c>
    ...
    4524:	7c048493          	add	s1,s1,1984 # 7ce0 <malloc+0x1cac>
    4528:	4581                	li	a1,0
    452a:	8526                	mv	a0,s1
    ...
    454c:	79850513          	add	a0,a0,1944 # 7ce0 <malloc+0x1cac>
...
000000000000456c <killstatus>:
{
  ...
  exit(0);
    ...
    45d2:	43250513          	add	a0,a0,1074 # 6a00 <malloc+0x9cc>
    ...
    45f8:	6fc50513          	add	a0,a0,1788 # 7cf0 <malloc+0x1cbc>
...
000000000000460e <preempt>:
{
  ...
  if(pid1 == 0)
    ...
    4638:	58c50513          	add	a0,a0,1420 # 6bc0 <malloc+0xb8c>
  ...
  if(pid2 == 0)
    ...
    4666:	39e50513          	add	a0,a0,926 # 6a00 <malloc+0x9cc>
  ...
  if(pid3 == 0){
    ...
    46aa:	b4258593          	add	a1,a1,-1214 # 61e8 <malloc+0x1b4>
    ...
    46d4:	33050513          	add	a0,a0,816 # 6a00 <malloc+0x9cc>
    ...
    46f0:	62450513          	add	a0,a0,1572 # 7d10 <malloc+0x1cdc>
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    4710:	8ec58593          	add	a1,a1,-1812 # dff8 <buf>
    ...
    472c:	60050513          	add	a0,a0,1536 # 7d28 <malloc+0x1cf4>
  ...
  printf("kill... ");
    ...
    4758:	5ec50513          	add	a0,a0,1516 # 7d40 <malloc+0x1d0c>
  ...
  printf("wait... ");
    ...
    4786:	5ce50513          	add	a0,a0,1486 # 7d50 <malloc+0x1d1c>
...
00000000000047b2 <reparent>:
{
  ...
  exit(0);
    ...
    4806:	1fe50513          	add	a0,a0,510 # 6a00 <malloc+0x9cc>
    ...
    4822:	36a50513          	add	a0,a0,874 # 6b88 <malloc+0xb54>
...
0000000000004862 <sbrkfail>:
{
  ...
  if(pipe(fds) != 0){
    ...
    4898:	27450513          	add	a0,a0,628 # 6b08 <malloc+0xad4>
    ...
    48cc:	92058593          	add	a1,a1,-1760 # 61e8 <malloc+0x1b4>
  ...
  if(xstatus != -1 && xstatus != 2)
    ...
    4990:	3d450513          	add	a0,a0,980 # 7d60 <malloc+0x1d2c>
    ...
    49ac:	05850513          	add	a0,a0,88 # 6a00 <malloc+0x9cc>
    ...
    49f8:	38c50513          	add	a0,a0,908 # 7d80 <malloc+0x1d4c>
...
0000000000004a18 <mem>:
{
  ...
  if((pid = fork()) == 0){
    ...
    4a62:	5d6080e7          	jalr	1494(ra) # 6034 <malloc>
    ...
    4a9c:	31850513          	add	a0,a0,792 # 7db0 <malloc+0x1d7c>
...
0000000000004abc <sharedfd>:
{
  ...
  if(pid == 0) {
    ...
    4b5e:	28650513          	add	a0,a0,646 # 7de0 <malloc+0x1dac>
    ...
    4b7a:	29250513          	add	a0,a0,658 # 7e08 <malloc+0x1dd4>
  ...
  fd = open("sharedfd", 0);
    ...
    4bbe:	21650513          	add	a0,a0,534 # 7dd0 <malloc+0x1d9c>
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    4bfe:	22e50513          	add	a0,a0,558 # 7e28 <malloc+0x1df4>
  ...
  unlink("sharedfd");
    ...
    4c3a:	19a50513          	add	a0,a0,410 # 7dd0 <malloc+0x1d9c>
  ...
  if(nc == N*SZ && np == N*SZ){
    ...
    4c60:	1f450513          	add	a0,a0,500 # 7e50 <malloc+0x1e1c>
...
0000000000004c80 <fourfiles>:
{
  ...
  char *names[] = { "f0", "f1", "f2", "f3" };
    ...
    4ca4:	1c878793          	add	a5,a5,456 # 7e68 <malloc+0x1e34>
    4ca8:	f6f43823          	sd	a5,-144(s0)
    4cac:	00003797          	auipc	a5,0x3
    4cb0:	1c478793          	add	a5,a5,452 # 7e70 <malloc+0x1e3c>
    4cb4:	f6f43c23          	sd	a5,-136(s0)
    4cb8:	00003797          	auipc	a5,0x3
    4cbc:	1c078793          	add	a5,a5,448 # 7e78 <malloc+0x1e44>
    4cc0:	f8f43023          	sd	a5,-128(s0)
    4cc4:	00003797          	auipc	a5,0x3
    4cc8:	1bc78793          	add	a5,a5,444 # 7e80 <malloc+0x1e4c>
  ...
  for(pi = 0; pi < NCHILD; pi++){
    ...
    4d20:	2dca0a13          	add	s4,s4,732 # dff8 <buf>
    if(total != N*SZ){
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    4d36:	0d650513          	add	a0,a0,214 # 6e08 <malloc+0xdd4>
    ...
    4db0:	0dc50513          	add	a0,a0,220 # 7e88 <malloc+0x1e54>
    ...
    4dca:	0d250513          	add	a0,a0,210 # 7e98 <malloc+0x1e64>
    ...
    4df0:	0c450513          	add	a0,a0,196 # 7eb0 <malloc+0x1e7c>
    ...
    4e20:	1dc78793          	add	a5,a5,476 # dff8 <buf>
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    4e78:	04c50513          	add	a0,a0,76 # 7ec0 <malloc+0x1e8c>
...
0000000000004eac <concreate>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    4eda:	002b8b93          	add	s7,s7,2 # 7ed8 <malloc+0x1ea4>
  for(i = 0; i < N; i++){
    ...
    4f1c:	fc850513          	add	a0,a0,-56 # 7ee0 <malloc+0x1eac>
    ...
    4f3a:	fa250513          	add	a0,a0,-94 # 7ed8 <malloc+0x1ea4>
  ...
  fd = open(".", 0);
    ...
    4f72:	8f250513          	add	a0,a0,-1806 # 6860 <malloc+0x82c>
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    4fea:	f1a50513          	add	a0,a0,-230 # 7f00 <malloc+0x1ecc>
    ...
    500a:	f1a50513          	add	a0,a0,-230 # 7f20 <malloc+0x1eec>
  ...
  for(i = 0; i < N; i++){
    ...
    5042:	f0a50513          	add	a0,a0,-246 # 7f48 <malloc+0x1f14>
    ...
    505e:	9a650513          	add	a0,a0,-1626 # 6a00 <malloc+0x9cc>
...
0000000000005208 <bigfile>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    5248:	db490913          	add	s2,s2,-588 # dff8 <buf>
  for(i = 0; i < N; i++){
    524c:	4a51                	li	s4,20
  if(fd < 0){
  ...
  fd = open("bigfile.dat", 0);
    ...
    5290:	cf450513          	add	a0,a0,-780 # 7f80 <malloc+0x1f4c>
  ...
  for(i = 0; ; i++){
    ...
    52a6:	d5690913          	add	s2,s2,-682 # dff8 <buf>
  if(fd < 0){
  ...
  for(i = 0; ; i++){
    ...
    52f4:	ca050513          	add	a0,a0,-864 # 7f90 <malloc+0x1f5c>
    ...
    5310:	ca450513          	add	a0,a0,-860 # 7fb0 <malloc+0x1f7c>
    ...
    532c:	ca850513          	add	a0,a0,-856 # 7fd0 <malloc+0x1f9c>
    ...
    5348:	cac50513          	add	a0,a0,-852 # 7ff0 <malloc+0x1fbc>
    ...
    5364:	cb050513          	add	a0,a0,-848 # 8010 <malloc+0x1fdc>
    ...
    5380:	cac50513          	add	a0,a0,-852 # 8028 <malloc+0x1ff4>
  ...
  unlink("bigfile.dat");
    ...
    53ae:	bd650513          	add	a0,a0,-1066 # 7f80 <malloc+0x1f4c>
    ...
    53d2:	c7a50513          	add	a0,a0,-902 # 8048 <malloc+0x2014>
...
00000000000053e8 <fsfull>:
{
  ...
  printf("fsfull test\n");
    ...
    5408:	c6450513          	add	a0,a0,-924 # 8068 <malloc+0x2034>
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    5428:	c54c8c93          	add	s9,s9,-940 # 8078 <malloc+0x2044>
    name[0] = 'f';
    ...
    5498:	bf450513          	add	a0,a0,-1036 # 8088 <malloc+0x2054>
  ...
  printf("fsfull test finished\n");
    ...
    550e:	b9e50513          	add	a0,a0,-1122 # 80a8 <malloc+0x2074>
    ...
    553c:	ac0a8a93          	add	s5,s5,-1344 # dff8 <buf>
      if(cc < BSIZE)
    ...
    5564:	b3850513          	add	a0,a0,-1224 # 8098 <malloc+0x2064>
...
run(void f(char *), char *s) {
  ...
  printf("test %s: ", s);
    ...
    5596:	b2e50513          	add	a0,a0,-1234 # 80c0 <malloc+0x208c>
  ...
  if(pid == 0) {
    ...
    55c6:	b2650513          	add	a0,a0,-1242 # 80e8 <malloc+0x20b4>
    ...
    55ea:	aea50513          	add	a0,a0,-1302 # 80d0 <malloc+0x209c>
    ...
    5612:	ae250513          	add	a0,a0,-1310 # 80f0 <malloc+0x20bc>
...
runtests(struct test *tests, char *justone) {
  ...
  for (struct test *t = tests; t->s != 0; t++) {
    ...
    5662:	a9a50513          	add	a0,a0,-1382 # 80f8 <malloc+0x20c4>
...
countfree()
{
  ...
  if(pid == 0){
    ...
    56bc:	b3098993          	add	s3,s3,-1232 # 61e8 <malloc+0x1b4>
      uint64 a = (uint64) sbrk(4096);
    ...
    56ee:	a6650513          	add	a0,a0,-1434 # 8150 <malloc+0x211c>
    ...
    570e:	a0650513          	add	a0,a0,-1530 # 8110 <malloc+0x20dc>
    ...
    572e:	a0650513          	add	a0,a0,-1530 # 8130 <malloc+0x20fc>
  ...
  while(1){
    ...
    5782:	9f250513          	add	a0,a0,-1550 # 8170 <malloc+0x213c>
...
drivetests(int quick, int continuous, char *justone) {
  ...
  do {
    ...
    57e0:	9b4b8b93          	add	s7,s7,-1612 # 8190 <malloc+0x215c>
    int free0 = countfree();
    int free1 = 0;
    ...
    57f2:	f72c0c13          	add	s8,s8,-142 # a760 <slowtests>
        printf("usertests slow tests starting\n");
    57f6:	00003d17          	auipc	s10,0x3
    57fa:	9b2d0d13          	add	s10,s10,-1614 # 81a8 <malloc+0x2174>
          return 1;
        }
      }
    }
    ...
    5802:	9cac8c93          	add	s9,s9,-1590 # 81c8 <malloc+0x2194>
...
main(int argc, char *argv[])
{
  ...
  if(argc == 2 && strcmp(argv[1], "-q") == 0){
    ...
    58da:	92258593          	add	a1,a1,-1758 # 81f8 <malloc+0x21c4>
  ...
  char *justone = 0;
    ...
    58f8:	90c58593          	add	a1,a1,-1780 # 8200 <malloc+0x21cc>
    ...
    590e:	94658593          	add	a1,a1,-1722 # 8250 <malloc+0x221c>
  ...
  int continuous = 0;
    ...
    593a:	8d250513          	add	a0,a0,-1838 # 8208 <malloc+0x21d4>
  ...
  printf("ALL TESTS PASSED\n");
    ...
    5960:	8dc50513          	add	a0,a0,-1828 # 8238 <malloc+0x2204>
...
0000000000005cac <getschedhistory>:
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    ...
    5cf8:	92450513          	add	a0,a0,-1756 # 8618 <digits>
    5cfc:	883a                	mv	a6,a4
    5cfe:	2705                	addw	a4,a4,1
    5d00:	02c5f7bb          	remuw	a5,a1,a2
    5d04:	1782                	sll	a5,a5,0x20
    5d06:	9381                	srl	a5,a5,0x20
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  putc(fd, 'x');
    ...
    5e86:	00002b97          	auipc	s7,0x2
    5e8a:	792b8b93          	add	s7,s7,1938 # 8618 <digits>
    5e8e:	03c9d793          	srl	a5,s3,0x3c
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    5ea2:	0992                	sll	s3,s3,0x4
    5ea4:	397d                	addw	s2,s2,-1
    ...
    5ee0:	6dc90913          	add	s2,s2,1756 # 85b8 <malloc+0x2584>
        while(*s != 0){
    5ee4:	02800593          	li	a1,40
    5ee8:	bff1                	j	5ec4 <vprintf+0x142>
        putc(fd, va_arg(ap, uint));
    5eea:	008b8913          	add	s2,s7,8
...
{
    5f4e:	715d                	add	sp,sp,-80
    5f50:	ec06                	sd	ra,24(sp)
    5f52:	e822                	sd	s0,16(sp)
    5f54:	1000                	add	s0,sp,32
...
{
    5f7c:	711d                	add	sp,sp,-96
    5f7e:	ec06                	sd	ra,24(sp)
    5f80:	e822                	sd	s0,16(sp)
    5f82:	1000                	add	s0,sp,32
...
free(void *ap)
{
    5fb2:	1141                	add	sp,sp,-16
    5fb4:	e422                	sd	s0,8(sp)
    5fb6:	0800                	add	s0,sp,16
  Header *bp, *p;

  bp = (Header*)ap - 1;
    5fb8:	ff050693          	add	a3,a0,-16
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    5fbc:	00005797          	auipc	a5,0x5
    5fc0:	8147b783          	ld	a5,-2028(a5) # a7d0 <freep>
    5fc4:	a02d                	j	5fee <free+0x3c>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
      break;
  if(bp + bp->s.size == p->s.ptr){
    bp->s.size += p->s.ptr->s.size;
    5fc6:	4618                	lw	a4,8(a2)
    5fc8:	9f2d                	addw	a4,a4,a1
    5fca:	fee52c23          	sw	a4,-8(a0)
    bp->s.ptr = p->s.ptr->s.ptr;
    5fce:	6398                	ld	a4,0(a5)
    5fd0:	6310                	ld	a2,0(a4)
    5fd2:	a83d                	j	6010 <free+0x5e>
  } else
    bp->s.ptr = p->s.ptr;
  if(p + p->s.size == bp){
    p->s.size += bp->s.size;
    5fd4:	ff852703          	lw	a4,-8(a0)
    5fd8:	9f31                	addw	a4,a4,a2
    5fda:	c798                	sw	a4,8(a5)
    p->s.ptr = bp->s.ptr;
    5fdc:	ff053683          	ld	a3,-16(a0)
    5fe0:	a091                	j	6024 <free+0x72>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    5fe2:	6398                	ld	a4,0(a5)
    5fe4:	00e7e463          	bltu	a5,a4,5fec <free+0x3a>
    5fe8:	00e6ea63          	bltu	a3,a4,5ffc <free+0x4a>
{
    5fec:	87ba                	mv	a5,a4
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    5fee:	fed7fae3          	bgeu	a5,a3,5fe2 <free+0x30>
    5ff2:	6398                	ld	a4,0(a5)
    5ff4:	00e6e463          	bltu	a3,a4,5ffc <free+0x4a>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    5ff8:	fee7eae3          	bltu	a5,a4,5fec <free+0x3a>
  if(bp + bp->s.size == p->s.ptr){
    5ffc:	ff852583          	lw	a1,-8(a0)
    6000:	6390                	ld	a2,0(a5)
    6002:	02059813          	sll	a6,a1,0x20
    6006:	01c85713          	srl	a4,a6,0x1c
    600a:	9736                	add	a4,a4,a3
    600c:	fae60de3          	beq	a2,a4,5fc6 <free+0x14>
    bp->s.ptr = p->s.ptr->s.ptr;
    6010:	fec53823          	sd	a2,-16(a0)
  if(p + p->s.size == bp){
    6014:	4790                	lw	a2,8(a5)
    6016:	02061593          	sll	a1,a2,0x20
    601a:	01c5d713          	srl	a4,a1,0x1c
    601e:	973e                	add	a4,a4,a5
    6020:	fae68ae3          	beq	a3,a4,5fd4 <free+0x22>
    p->s.ptr = bp->s.ptr;
    6024:	e394                	sd	a3,0(a5)
  } else
    p->s.ptr = bp;
  freep = p;
    6026:	00004717          	auipc	a4,0x4
    602a:	7af73523          	sd	a5,1962(a4) # a7d0 <freep>
}
    602e:	6422                	ld	s0,8(sp)
    6030:	0141                	add	sp,sp,16
    6032:	8082                	ret
...
malloc(uint nbytes)
{
    6034:	7139                	add	sp,sp,-64
    6036:	fc06                	sd	ra,56(sp)
    6038:	f822                	sd	s0,48(sp)
    603a:	f426                	sd	s1,40(sp)
    603c:	ec4e                	sd	s3,24(sp)
    603e:	0080                	add	s0,sp,64
  Header *p, *prevp;
  uint nunits;

  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    6040:	02051493          	sll	s1,a0,0x20
    6044:	9081                	srl	s1,s1,0x20
    6046:	04bd                	add	s1,s1,15
    6048:	8091                	srl	s1,s1,0x4
    604a:	0014899b          	addw	s3,s1,1
    604e:	0485                	add	s1,s1,1
  if((prevp = freep) == 0){
    6050:	00004517          	auipc	a0,0x4
    6054:	78053503          	ld	a0,1920(a0) # a7d0 <freep>
    6058:	c915                	beqz	a0,608c <malloc+0x58>
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    605e:	08977e63          	bgeu	a4,s1,60fa <malloc+0xc6>
    6062:	f04a                	sd	s2,32(sp)
    6064:	e852                	sd	s4,16(sp)
    6066:	e456                	sd	s5,8(sp)
    6068:	e05a                	sd	s6,0(sp)
  if(nu < 4096)
    606a:	8a4e                	mv	s4,s3
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    if(p == freep)
    6080:	00004917          	auipc	s2,0x4
    6084:	75090913          	add	s2,s2,1872 # a7d0 <freep>
  if(p == (char*)-1)
    6088:	5afd                	li	s5,-1
    608a:	a091                	j	60ce <malloc+0x9a>
    608c:	f04a                	sd	s2,32(sp)
    608e:	e852                	sd	s4,16(sp)
    6090:	e456                	sd	s5,8(sp)
    6092:	e05a                	sd	s6,0(sp)
    base.s.ptr = freep = prevp = &base;
    6094:	0000b797          	auipc	a5,0xb
    6098:	f6478793          	add	a5,a5,-156 # 10ff8 <base>
    609c:	00004717          	auipc	a4,0x4
    60a0:	72f73a23          	sd	a5,1844(a4) # a7d0 <freep>
    60a4:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
    60a6:	0007a423          	sw	zero,8(a5)
    if(p->s.size >= nunits){
    60aa:	b7c1                	j	606a <malloc+0x36>
        prevp->s.ptr = p->s.ptr;
    60ac:	6398                	ld	a4,0(a5)
    60ae:	e118                	sd	a4,0(a0)
    60b0:	a08d                	j	6112 <malloc+0xde>
  hp->s.size = nu;
    60b2:	01652423          	sw	s6,8(a0)
  free((void*)(hp + 1));
    60b6:	0541                	add	a0,a0,16
    60b8:	00000097          	auipc	ra,0x0
    60bc:	efa080e7          	jalr	-262(ra) # 5fb2 <free>
  return freep;
    60c0:	00093503          	ld	a0,0(s2)
      if((p = morecore(nunits)) == 0)
    60c4:	c13d                	beqz	a0,612a <malloc+0xf6>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    60c6:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    60c8:	4798                	lw	a4,8(a5)
    60ca:	02977463          	bgeu	a4,s1,60f2 <malloc+0xbe>
    if(p == freep)
    60ce:	00093703          	ld	a4,0(s2)
    60d2:	853e                	mv	a0,a5
    60d4:	fef719e3          	bne	a4,a5,60c6 <malloc+0x92>
  p = sbrk(nu * sizeof(Header));
    60d8:	8552                	mv	a0,s4
    60da:	00000097          	auipc	ra,0x0
    60de:	baa080e7          	jalr	-1110(ra) # 5c84 <sbrk>
  if(p == (char*)-1)
    60e2:	fd5518e3          	bne	a0,s5,60b2 <malloc+0x7e>
        return 0;
    60e6:	4501                	li	a0,0
    ...
    60f0:	a03d                	j	611e <malloc+0xea>
    60f2:	7902                	ld	s2,32(sp)
    60f4:	6a42                	ld	s4,16(sp)
    60f6:	6aa2                	ld	s5,8(sp)
    60f8:	6b02                	ld	s6,0(sp)
      if(p->s.size == nunits)
    60fa:	fae489e3          	beq	s1,a4,60ac <malloc+0x78>
        p->s.size -= nunits;
    60fe:	4137073b          	subw	a4,a4,s3
    6102:	c798                	sw	a4,8(a5)
        p += p->s.size;
    6104:	02071693          	sll	a3,a4,0x20
    6108:	01c6d713          	srl	a4,a3,0x1c
    610c:	97ba                	add	a5,a5,a4
        p->s.size = nunits;
    610e:	0137a423          	sw	s3,8(a5)
      freep = prevp;
    6112:	00004717          	auipc	a4,0x4
    6116:	6aa73f23          	sd	a0,1726(a4) # a7d0 <freep>
      return (void*)(p + 1);
    611a:	01078513          	add	a0,a5,16
  }
}
    611e:	70e2                	ld	ra,56(sp)
    6120:	7442                	ld	s0,48(sp)
    6122:	74a2                	ld	s1,40(sp)
    6124:	69e2                	ld	s3,24(sp)
    6126:	6121                	add	sp,sp,64
    6128:	8082                	ret
    612a:	7902                	ld	s2,32(sp)
    612c:	6a42                	ld	s4,16(sp)
    612e:	6aa2                	ld	s5,8(sp)
    6130:	6b02                	ld	s6,0(sp)
    6132:	b7f5                	j	611e <malloc+0xea>
